...
AMDGPUInstructionSelector::getSubOperand64(MachineOperand &MO,
  ...
  if (MO.isReg()) {
    ...
    TII.buildCopy(*BB, MI, MI->getDebugLoc(), DstReg, Reg, 0, ComposedSubIdx);
...
bool AMDGPUInstructionSelector::selectG_UADDO_USUBO_UADDE_USUBE(
  ...
  if (HasCarryIn) {
    TII.buildCopy(*BB, &I, DL, AMDGPU::SCC, I.getOperand(4).getReg());
  }
  ...
  BuildMI(*BB, &I, DL, TII.get(HasCarryIn ? CarryOpc : NoCarryOpc), Dst0Reg)
    .add(I.getOperand(2))
    .add(I.getOperand(3));
  TII.buildCopy(*BB, &I, DL, Dst1Reg, AMDGPU::SCC);
...
bool AMDGPUInstructionSelector::selectG_EXTRACT(MachineInstr &I) const {
  ...
  const DebugLoc &DL = I.getDebugLoc();
  TII.buildCopy(*BB, &I, DL, DstReg, SrcReg, 0, SubReg);
...
bool AMDGPUInstructionSelector::selectG_UNMERGE_VALUES(MachineInstr &MI) const {
  ...
  for (int I = 0, E = NumDst; I != E; ++I) {
    ...
    TII.buildCopy(*BB, &MI, DL, Dst.getReg(), SrcReg, 0, SubRegs[I]);
...
bool AMDGPUInstructionSelector::selectInterpP1F16(MachineInstr &MI) const {
  ...
  TII.buildCopy(*MBB, &MI, DL, AMDGPU::M0, M0Val);
...
bool AMDGPUInstructionSelector::selectWritelane(MachineInstr &MI) const {
  ...
  if (ConstSelect) {
    ...
    if (ConstVal && AMDGPU::isInlinableLiteral32(ConstVal->Value.getSExtValue(),
      ...
      TII.buildCopy(*MBB, *MIB, DL, AMDGPU::M0, LaneSelect);
...
bool AMDGPUInstructionSelector::selectG_ICMP(MachineInstr &I) const {
  ...
  if (!isVCC(CCReg, *MRI)) {
    ...
    MachineInstr *ICmp = BuildMI(*BB, &I, DL, TII.get(Opcode))
            .add(I.getOperand(2))
            .add(I.getOperand(3));
    TII.buildCopy(*BB, &I, DL, CCReg, AMDGPU::SCC);
    bool Ret =
...
bool AMDGPUInstructionSelector::selectBallot(MachineInstr &I) const {
  ...
  if (Arg) {
    ...
    if (Value == 0) {
      ...
      TII.buildCopy(*BB, &I, DL, DstReg, SrcReg);
    } else
      return false;
  } else {
    Register SrcReg = I.getOperand(2).getReg();
...
bool AMDGPUInstructionSelector::selectReturnAddress(MachineInstr &I) const {
  ...
  TII.buildCopy(*MBB, &I, DL, DstReg, LiveIn);
  I.eraseFromParent();
  return true;
}
...
bool AMDGPUInstructionSelector::selectDSGWSIntrinsic(MachineInstr &MI,
  ...
  if (OffsetDef->getOpcode() == AMDGPU::G_CONSTANT) {
    ...
    TII.buildCopy(*MBB, &MI, DL, AMDGPU::M0, M0Base);
  }
...
bool AMDGPUInstructionSelector::selectDSAppendConsume(MachineInstr &MI,
  ...
  TII.buildCopy(*MBB, &MI, DL, AMDGPU::M0, PtrBase);
  ...
  if (VDataOut) {
    if (BaseOpcode->AtomicX2) {
      ...
      if (!MRI->use_empty(VDataOut)) {
        TII.buildCopy(*MBB, &MI, DL, VDataOut, TmpReg, RegState::Kill, SubReg);
      }
...
bool AMDGPUInstructionSelector::selectG_SELECT(MachineInstr &I) const {
  ...
  if (!isVCC(CCReg, *MRI)) {
    ...
    MachineInstr *CopySCC = TII.buildCopy(*BB, &I, DL, AMDGPU::SCC, CCReg);
...
bool AMDGPUInstructionSelector::selectG_TRUNC(MachineInstr &I) const {
  ...
  if (DstTy == LLT::fixed_vector(2, 16) && SrcTy == LLT::fixed_vector(2, 32)) {
    ...
    TII.buildCopy(*MBB, I, DL, LoReg, SrcReg, 0, AMDGPU::sub0);
    TII.buildCopy(*MBB, I, DL, HiReg, SrcReg, 0, AMDGPU::sub1);
...
bool AMDGPUInstructionSelector::selectG_FNEG(MachineInstr &MI) const {
  ...
  TII.buildCopy(*BB, &MI, DL, LoReg, Src, 0, AMDGPU::sub0);
  TII.buildCopy(*BB, &MI, DL, HiReg, Src, 0, AMDGPU::sub1);
...
bool AMDGPUInstructionSelector::selectG_BRCOND(MachineInstr &I) const {
  ...
  TII.buildCopy(*BB, &I, DL, CondPhysReg, CondReg);
...
bool AMDGPUInstructionSelector::selectG_PTRMASK(MachineInstr &I) const {
  ...
  TII.buildCopy(*BB, &I, DL, LoReg, SrcReg, 0, AMDGPU::sub0);
  TII.buildCopy(*BB, &I, DL, HiReg, SrcReg, 0, AMDGPU::sub1);
  ...
  if (CanCopyLow32) {
    ...
    TII.buildCopy(*BB, &I, DL, MaskLo, MaskReg, 0, AMDGPU::sub0);
  ...
  if (CanCopyHi32) {
    ...
    TII.buildCopy(*BB, &I, DL, MaskHi, MaskReg, 0, AMDGPU::sub1);
...
bool AMDGPUInstructionSelector::selectG_EXTRACT_VECTOR_ELT(
  ...
  if (SrcRB->getID() == AMDGPU::SGPRRegBankID) {
    ...
    TII.buildCopy(*BB, &MI, DL, AMDGPU::M0, IdxReg);
...
bool AMDGPUInstructionSelector::selectG_SHUFFLE_VECTOR(
  ...
  if (isZeroOrUndef(Mask[0]) && isOneOrUndef(Mask[1])) {
    TII.buildCopy(*MBB, MI, DL, DstReg, SrcVec);
...
std::pair<Register, unsigned> AMDGPUInstructionSelector::selectVOP3ModsImpl(
  ...
  if ((Mods != 0 || ForceVGPR) &&
    ...
    TII.buildCopy(*UseMI->getParent(), UseMI, UseMI->getDebugLoc(), VGPRSrc,
                  Src);
    Src = VGPRSrc;
  }
