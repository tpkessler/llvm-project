...
; GCN-O0-NEXT:       GPU Load and Store Vectorizer
...
; GCN-O1-NEXT:       Split GEPs to a variadic base and a constant offset for better CSE
; GCN-O1-NEXT:       Speculatively execute instructions
; GCN-O1-NEXT:       Scalar Evolution Analysis
; GCN-O1-NEXT:       Straight line strength reduction
; GCN-O1-NEXT:       Early CSE
; GCN-O1-NEXT:       Scalar Evolution Analysis
; GCN-O1-NEXT:       Nary reassociation
; GCN-O1-NEXT:       Early CSE
...
; GCN-O1-NEXT:       Natural Loop Information
; GCN-O1-NEXT:       Scalar Evolution Analysis
; GCN-O1-NEXT:       GPU Load and Store Vectorizer
...
; GCN-O1-NEXT:         GCN RegBank Reassign
...
; GCN-O1-OPTS-NEXT:         GCN RegBank Reassign
...
; GCN-O2-NEXT:         GCN RegBank Reassign
...
; GCN-O3-NEXT:         GCN RegBank Reassign
