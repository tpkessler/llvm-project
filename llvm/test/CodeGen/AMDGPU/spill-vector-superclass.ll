...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN-NEXT:   undef %23.sub0:av_64 = PRED_COPY %21.sub0
  ...
  ; GCN-NEXT:   GLOBAL_STORE_DWORDX4 undef %16:vreg_64, [[PRED_COPY1]], 0, 0, implicit $exec :: (volatile store (s128) into `<4 x i32> addrspace(1)* undef`, addrspace 1)
  ...
  ; GCN-NEXT:   undef %22.sub0:vreg_64 = PRED_COPY %24.sub0
