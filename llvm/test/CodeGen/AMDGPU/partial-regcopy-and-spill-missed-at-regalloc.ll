...
define amdgpu_kernel void @partial_copy(<4 x i32> %arg) #0 {
  ...
  ; REGALLOC-GFX908-NEXT:   [[PRED_COPY:%[0-9]+]]:av_128 = PRED_COPY %26
  ...
  ; REGALLOC-GFX908-NEXT:   [[PRED_COPY1:%[0-9]+]]:vreg_128 = PRED_COPY [[PRED_COPY]]
  ; REGALLOC-GFX908-NEXT:   GLOBAL_STORE_DWORDX4 undef %14:vreg_64, [[PRED_COPY1]], 0, 0, implicit $exec :: (volatile store (s128) into `<4 x i32> addrspace(1)* undef`, addrspace 1)
  ...
  ; REGALLOC-GFX908-NEXT:   [[PRED_COPY2:%[0-9]+]]:areg_128 = PRED_COPY killed renamable $sgpr0_sgpr1_sgpr2_sgpr3
  ; REGALLOC-GFX908-NEXT:   [[V_MOV_B32_e32_1:%[0-9]+]]:vgpr_32 = V_MOV_B32_e32 2, implicit $exec
  ; REGALLOC-GFX908-NEXT:   [[V_MFMA_I32_4X4X4I8_e64_:%[0-9]+]]:areg_128 = V_MFMA_I32_4X4X4I8_e64 [[V_MOV_B32_e32_]], [[V_MOV_B32_e32_1]], [[PRED_COPY2]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; REGALLOC-GFX908-NEXT:   [[PRED_COPY3:%[0-9]+]]:vreg_128 = PRED_COPY [[V_MFMA_I32_4X4X4I8_e64_]]
  ; REGALLOC-GFX908-NEXT:   GLOBAL_STORE_DWORDX4 undef %18:vreg_64, [[PRED_COPY3]], 0, 0, implicit $exec :: (volatile store (s128) into `<4 x i32> addrspace(1)* undef`, addrspace 1)
  ...
  ; PEI-GFX908-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = PRED_COPY killed renamable $vgpr0_vgpr1_vgpr2_vgpr3, implicit $exec
  ...
  ; PEI-GFX908-NEXT:   renamable $vgpr0_vgpr1_vgpr2_vgpr3 = PRED_COPY killed renamable $agpr0_agpr1_agpr2_agpr3, implicit $exec
  ...
  ; PEI-GFX908-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = PRED_COPY killed renamable $sgpr0_sgpr1_sgpr2_sgpr3, implicit $exec
  ...
  ; REGALLOC-GFX90A-NEXT:   [[PRED_COPY:%[0-9]+]]:av_128_align2 = PRED_COPY %25
  ...
  ; REGALLOC-GFX90A-NEXT:   GLOBAL_STORE_DWORDX4 undef %14:vreg_64_align2, [[PRED_COPY]], 0, 0, implicit $exec :: (volatile store (s128) into `<4 x i32> addrspace(1)* undef`, addrspace 1)
  ...
  ; REGALLOC-GFX90A-NEXT:   [[PRED_COPY1:%[0-9]+]]:areg_128_align2 = PRED_COPY killed renamable $sgpr0_sgpr1_sgpr2_sgpr3
  ...
  ; REGALLOC-GFX90A-NEXT:   [[V_MFMA_I32_4X4X4I8_e64_:%[0-9]+]]:areg_128_align2 = V_MFMA_I32_4X4X4I8_e64 [[V_MOV_B32_e32_]], [[V_MOV_B32_e32_1]], [[PRED_COPY1]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; PEI-GFX90A-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = PRED_COPY killed renamable $vgpr0_vgpr1_vgpr2_vgpr3, implicit $exec
  ...
  ; PEI-GFX90A-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = PRED_COPY killed renamable $sgpr0_sgpr1_sgpr2_sgpr3, implicit $exec
