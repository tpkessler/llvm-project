...
; CHECK-NEXT:    s_add_i32 s20, s33, 0x100200
; CHECK-NEXT:    buffer_store_dword v3, off, s[0:3], s20 ; 4-byte Folded Spill
...
; CHECK-NEXT:    s_or_saveexec_b64 s[34:35], -1
; CHECK-NEXT:    s_add_i32 s24, s33, 0x100200
; CHECK-NEXT:    buffer_load_dword v0, off, s[0:3], s24 ; 4-byte Folded Reload
; CHECK-NEXT:    s_mov_b64 exec, s[34:35]
; CHECK-NEXT:    s_load_dword s8, s[16:17], 0x0
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v0, s8, 1
; CHECK-NEXT:    s_or_saveexec_b64 s[34:35], -1
; CHECK-NEXT:    s_add_i32 s36, s33, 0x100200
; CHECK-NEXT:    buffer_store_dword v0, off, s[0:3], s36 ; 4-byte Folded Spill
; CHECK-NEXT:    s_mov_b64 exec, s[34:35]
; CHECK-NEXT:    ;;#ASMSTART
...
; CHECK-NEXT:    s_or_saveexec_b64 s[34:35], -1
; CHECK-NEXT:    s_add_i32 s6, s33, 0x100200
