...
define fastcc i32 @i32_fastcc_i32_i32(i32 %arg0, i32 %arg1) #1 {
  ...
  ; GCN-NEXT:   [[ADD:%[0-9]+]]:_(s32) = G_ADD [[PRED_COPY]], [[PRED_COPY1]]
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[ADD]](s32)
...
define hidden fastcc i32 @sibling_call_i32_fastcc_i32_i32(i32 %a, i32 %b, i32 %c) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s32) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(s32) = PRED_COPY $vgpr2
  ; GCN-NEXT:   [[GV:%[0-9]+]]:sreg_64(p0) = G_GLOBAL_VALUE @i32_fastcc_i32_i32
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY3]](<4 x s32>)
...
define amdgpu_kernel void @kernel_call_i32_fastcc_i32_i32_unused_result(i32 %a, i32 %b, i32 %c) #1 {
  ...
  ; GCN-NEXT: {{  $}}
  ; GCN-NEXT:   [[PRED_COPY:%[0-9]+]]:_(p4) = PRED_COPY $sgpr4_sgpr5
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[EVEC]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[EVEC1]](s32)
  ; GCN-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY1]](<4 x s32>)
  ...
  ; GCN-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
...
define hidden fastcc i32 @i32_fastcc_i32_byval_i32(i32 %arg0, i32 addrspace(5)* byval(i32) align 4 %arg1) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(p5) = PRED_COPY [[FRAME_INDEX]](p5)
  ; GCN-NEXT:   [[LOAD:%[0-9]+]]:_(s32) = G_LOAD [[PRED_COPY1]](p5) :: (dereferenceable load (s32) from %ir.arg1, addrspace 5)
  ; GCN-NEXT:   [[ADD:%[0-9]+]]:_(s32) = G_ADD [[PRED_COPY]], [[LOAD]]
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[ADD]](s32)
  ; GCN-NEXT:   SI_RETURN implicit $vgpr0
...
define fastcc i32 @sibling_call_i32_fastcc_i32_byval_i32_byval_parent(i32 %a, i32 addrspace(5)* byval(i32) %b.byval, i32 %c) #1 {
  ...
  ; GCN-NEXT:   G_MEMCPY [[PTR_ADD]](p5), [[PRED_COPY1]](p5), [[C1]](s32), 0 :: (dereferenceable store (s32) into stack, addrspace 5), (dereferenceable load (s32) from %ir.b.byval, addrspace 5)
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY3]](<4 x s32>)
  ...
  ; GCN-NEXT:   [[PRED_COPY4:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 4, implicit-def $scc
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY4]](s32)
  ; GCN-NEXT:   SI_RETURN implicit $vgpr0
entry:
...
define fastcc i32 @sibling_call_i32_fastcc_i32_byval_i32(i32 %a, [32 x i32] %large) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s32) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(s32) = PRED_COPY $vgpr2
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:_(s32) = PRED_COPY $vgpr3
  ; GCN-NEXT:   [[PRED_COPY4:%[0-9]+]]:_(s32) = PRED_COPY $vgpr4
  ; GCN-NEXT:   [[PRED_COPY5:%[0-9]+]]:_(s32) = PRED_COPY $vgpr5
  ; GCN-NEXT:   [[PRED_COPY6:%[0-9]+]]:_(s32) = PRED_COPY $vgpr6
  ; GCN-NEXT:   [[PRED_COPY7:%[0-9]+]]:_(s32) = PRED_COPY $vgpr7
  ; GCN-NEXT:   [[PRED_COPY8:%[0-9]+]]:_(s32) = PRED_COPY $vgpr8
  ; GCN-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(s32) = PRED_COPY $vgpr9
  ; GCN-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(s32) = PRED_COPY $vgpr10
  ; GCN-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(s32) = PRED_COPY $vgpr11
  ; GCN-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(s32) = PRED_COPY $vgpr12
  ; GCN-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s32) = PRED_COPY $vgpr13
  ; GCN-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY $vgpr14
  ; GCN-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY $vgpr15
  ; GCN-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY $vgpr16
  ; GCN-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY $vgpr17
  ; GCN-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY $vgpr18
  ; GCN-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY $vgpr19
  ; GCN-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(s32) = PRED_COPY $vgpr20
  ; GCN-NEXT:   [[PRED_COPY21:%[0-9]+]]:_(s32) = PRED_COPY $vgpr21
  ; GCN-NEXT:   [[PRED_COPY22:%[0-9]+]]:_(s32) = PRED_COPY $vgpr22
  ; GCN-NEXT:   [[PRED_COPY23:%[0-9]+]]:_(s32) = PRED_COPY $vgpr23
  ; GCN-NEXT:   [[PRED_COPY24:%[0-9]+]]:_(s32) = PRED_COPY $vgpr24
  ; GCN-NEXT:   [[PRED_COPY25:%[0-9]+]]:_(s32) = PRED_COPY $vgpr25
  ; GCN-NEXT:   [[PRED_COPY26:%[0-9]+]]:_(s32) = PRED_COPY $vgpr26
  ; GCN-NEXT:   [[PRED_COPY27:%[0-9]+]]:_(s32) = PRED_COPY $vgpr27
  ; GCN-NEXT:   [[PRED_COPY28:%[0-9]+]]:_(s32) = PRED_COPY $vgpr28
  ; GCN-NEXT:   [[PRED_COPY29:%[0-9]+]]:_(s32) = PRED_COPY $vgpr29
  ; GCN-NEXT:   [[PRED_COPY30:%[0-9]+]]:_(s32) = PRED_COPY $vgpr30
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   [[PRED_COPY31:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY31]](<4 x s32>)
...
define fastcc i32 @i32_fastcc_i32_i32_a32i32(i32 %arg0, i32 %arg1, [32 x i32] %large) #1 {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[ADD2]](s32)
  ; GCN-NEXT:   SI_RETURN implicit $vgpr0
...
define fastcc i32 @sibling_call_i32_fastcc_i32_i32_a32i32(i32 %a, i32 %b, [32 x i32] %c) #1 {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[PRED_COPY2]](s32)
  ; GCN-NEXT:   $vgpr3 = PRED_COPY [[PRED_COPY3]](s32)
  ; GCN-NEXT:   $vgpr4 = PRED_COPY [[PRED_COPY4]](s32)
  ; GCN-NEXT:   $vgpr5 = PRED_COPY [[PRED_COPY5]](s32)
  ; GCN-NEXT:   $vgpr6 = PRED_COPY [[PRED_COPY6]](s32)
  ; GCN-NEXT:   $vgpr7 = PRED_COPY [[PRED_COPY7]](s32)
  ; GCN-NEXT:   $vgpr8 = PRED_COPY [[PRED_COPY8]](s32)
  ; GCN-NEXT:   $vgpr9 = PRED_COPY [[PRED_COPY9]](s32)
  ; GCN-NEXT:   $vgpr10 = PRED_COPY [[PRED_COPY10]](s32)
  ; GCN-NEXT:   $vgpr11 = PRED_COPY [[PRED_COPY11]](s32)
  ; GCN-NEXT:   $vgpr12 = PRED_COPY [[PRED_COPY12]](s32)
  ; GCN-NEXT:   $vgpr13 = PRED_COPY [[PRED_COPY13]](s32)
  ; GCN-NEXT:   $vgpr14 = PRED_COPY [[PRED_COPY14]](s32)
  ; GCN-NEXT:   $vgpr15 = PRED_COPY [[PRED_COPY15]](s32)
  ; GCN-NEXT:   $vgpr16 = PRED_COPY [[PRED_COPY16]](s32)
  ; GCN-NEXT:   $vgpr17 = PRED_COPY [[PRED_COPY17]](s32)
  ; GCN-NEXT:   $vgpr18 = PRED_COPY [[PRED_COPY18]](s32)
  ; GCN-NEXT:   $vgpr19 = PRED_COPY [[PRED_COPY19]](s32)
  ; GCN-NEXT:   $vgpr20 = PRED_COPY [[PRED_COPY20]](s32)
  ; GCN-NEXT:   $vgpr21 = PRED_COPY [[PRED_COPY21]](s32)
  ; GCN-NEXT:   $vgpr22 = PRED_COPY [[PRED_COPY22]](s32)
  ; GCN-NEXT:   $vgpr23 = PRED_COPY [[PRED_COPY23]](s32)
  ; GCN-NEXT:   $vgpr24 = PRED_COPY [[PRED_COPY24]](s32)
  ; GCN-NEXT:   $vgpr25 = PRED_COPY [[PRED_COPY25]](s32)
  ; GCN-NEXT:   $vgpr26 = PRED_COPY [[PRED_COPY26]](s32)
  ; GCN-NEXT:   $vgpr27 = PRED_COPY [[PRED_COPY27]](s32)
  ; GCN-NEXT:   $vgpr28 = PRED_COPY [[PRED_COPY28]](s32)
  ; GCN-NEXT:   $vgpr29 = PRED_COPY [[PRED_COPY29]](s32)
  ; GCN-NEXT:   $vgpr30 = PRED_COPY [[PRED_COPY30]](s32)
  ; GCN-NEXT:   [[PRED_COPY31:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY31]](<4 x s32>)
...
define fastcc i32 @no_sibling_call_callee_more_stack_space(i32 %a, i32 %b) #1 {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr3 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr4 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr5 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr6 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr7 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr8 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr9 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr10 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr11 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr12 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr13 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr14 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr15 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr16 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr17 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr18 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr19 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr20 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr21 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr22 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr23 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr24 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr25 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr26 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr27 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr28 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr29 = PRED_COPY [[C]](s32)
  ; GCN-NEXT:   $vgpr30 = PRED_COPY [[C]](s32)
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY3]](s32)
  ; GCN-NEXT:   SI_RETURN implicit $vgpr0
entry:
...
define fastcc i32 @sibling_call_i32_fastcc_i32_i32_other_call(i32 %a, i32 %b, i32 %c) #1 {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[PRED_COPY4]](s32)
  ; GCN-NEXT:   [[PRED_COPY5:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY5]](<4 x s32>)
...
define fastcc i32 @sibling_call_stack_objecti32_fastcc_i32_i32_a32i32_larger_arg_area(i32 %a, i32 %b, [36 x i32] %c) #1 {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr3 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr4 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr5 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr6 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr7 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr8 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr9 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr10 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr11 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr12 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr13 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr14 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr15 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr16 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr17 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr18 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr19 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr20 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr21 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr22 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr23 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr24 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr25 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr26 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr27 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr28 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr29 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr30 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   [[PRED_COPY31:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY31]](<4 x s32>)
  ; GCN-NEXT:   SI_TCRETURN [[GV]](p0), @i32_fastcc_i32_i32_a32i32, 0, csr_amdgpu, implicit $vgpr0, implicit $vgpr1, implicit $vgpr2, implicit $vgpr3, implicit $vgpr4, implicit $vgpr5, implicit $vgpr6, implicit $vgpr7, implicit $vgpr8, implicit $vgpr9, implicit $vgpr10, implicit $vgpr11, implicit $vgpr12, implicit $vgpr13, implicit $vgpr14, implicit $vgpr15, implicit $vgpr16, implicit $vgpr17, implicit $vgpr18, implicit $vgpr19, implicit $vgpr20, implicit $vgpr21, implicit $vgpr22, implicit $vgpr23, implicit $vgpr24, implicit $vgpr25, implicit $vgpr26, implicit $vgpr27, implicit $vgpr28, implicit $vgpr29, implicit $vgpr30, implicit $sgpr0_sgpr1_sgpr2_sgpr3
entry:
...
define fastcc void @sibling_call_fastcc_multi_byval(i32 %a, [64 x i32]) #1 {
  ...
  ; GCN-NEXT: {{  $}}
  ; GCN-NEXT:   [[PRED_COPY:%[0-9]+]]:vgpr_32(s32) = PRED_COPY $vgpr31
  ; GCN-NEXT:   [[PRED_COPY1:%[0-9]+]]:sgpr_32(s32) = PRED_COPY $sgpr15
  ; GCN-NEXT:   [[PRED_COPY2:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr14
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr13
  ; GCN-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr12
  ; GCN-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr10_sgpr11
  ...
  ; GCN-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(s32) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(s32) = PRED_COPY $vgpr2
  ; GCN-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(s32) = PRED_COPY $vgpr3
  ; GCN-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s32) = PRED_COPY $vgpr4
  ; GCN-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY $vgpr5
  ; GCN-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY $vgpr6
  ; GCN-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY $vgpr7
  ; GCN-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY $vgpr8
  ; GCN-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY $vgpr9
  ; GCN-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY $vgpr10
  ; GCN-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(s32) = PRED_COPY $vgpr11
  ; GCN-NEXT:   [[PRED_COPY21:%[0-9]+]]:_(s32) = PRED_COPY $vgpr12
  ; GCN-NEXT:   [[PRED_COPY22:%[0-9]+]]:_(s32) = PRED_COPY $vgpr13
  ; GCN-NEXT:   [[PRED_COPY23:%[0-9]+]]:_(s32) = PRED_COPY $vgpr14
  ; GCN-NEXT:   [[PRED_COPY24:%[0-9]+]]:_(s32) = PRED_COPY $vgpr15
  ; GCN-NEXT:   [[PRED_COPY25:%[0-9]+]]:_(s32) = PRED_COPY $vgpr16
  ; GCN-NEXT:   [[PRED_COPY26:%[0-9]+]]:_(s32) = PRED_COPY $vgpr17
  ; GCN-NEXT:   [[PRED_COPY27:%[0-9]+]]:_(s32) = PRED_COPY $vgpr18
  ; GCN-NEXT:   [[PRED_COPY28:%[0-9]+]]:_(s32) = PRED_COPY $vgpr19
  ; GCN-NEXT:   [[PRED_COPY29:%[0-9]+]]:_(s32) = PRED_COPY $vgpr20
  ; GCN-NEXT:   [[PRED_COPY30:%[0-9]+]]:_(s32) = PRED_COPY $vgpr21
  ; GCN-NEXT:   [[PRED_COPY31:%[0-9]+]]:_(s32) = PRED_COPY $vgpr22
  ; GCN-NEXT:   [[PRED_COPY32:%[0-9]+]]:_(s32) = PRED_COPY $vgpr23
  ; GCN-NEXT:   [[PRED_COPY33:%[0-9]+]]:_(s32) = PRED_COPY $vgpr24
  ; GCN-NEXT:   [[PRED_COPY34:%[0-9]+]]:_(s32) = PRED_COPY $vgpr25
  ; GCN-NEXT:   [[PRED_COPY35:%[0-9]+]]:_(s32) = PRED_COPY $vgpr26
  ; GCN-NEXT:   [[PRED_COPY36:%[0-9]+]]:_(s32) = PRED_COPY $vgpr27
  ; GCN-NEXT:   [[PRED_COPY37:%[0-9]+]]:_(s32) = PRED_COPY $vgpr28
  ; GCN-NEXT:   [[PRED_COPY38:%[0-9]+]]:_(s32) = PRED_COPY $vgpr29
  ; GCN-NEXT:   [[PRED_COPY39:%[0-9]+]]:_(s32) = PRED_COPY $vgpr30
  ...
  ; GCN-NEXT:   [[PRED_COPY40:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]]
  ; GCN-NEXT:   [[PRED_COPY41:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; GCN-NEXT:   [[PRED_COPY42:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; GCN-NEXT:   [[PRED_COPY43:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY5]]
  ; GCN-NEXT:   [[PRED_COPY44:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GCN-NEXT:   [[PRED_COPY45:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GCN-NEXT:   [[PRED_COPY46:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ; GCN-NEXT:   [[PRED_COPY47:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   [[PRED_COPY48:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY9]](s32)
  ; GCN-NEXT:   [[PRED_COPY49:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY49]](<4 x s32>)
  ; GCN-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY40]](p4)
  ; GCN-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY41]](p4)
  ; GCN-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PRED_COPY42]](p4)
  ; GCN-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY43]](s64)
  ; GCN-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY44]](s32)
  ; GCN-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY45]](s32)
  ; GCN-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY46]](s32)
  ; GCN-NEXT:   $sgpr15 = PRED_COPY [[PRED_COPY47]](s32)
  ; GCN-NEXT:   $vgpr31 = PRED_COPY [[PRED_COPY48]](s32)
...
define fastcc void @sibling_call_byval_and_stack_passed(i32 %stack.out.arg, [64 x i32]) #1 {
  ...
  ; GCN-NEXT:   [[FRAME_INDEX37:%[0-9]+]]:_(p5) = G_FRAME_INDEX %fixed-stack.0
  ; GCN-NEXT:   G_STORE [[PRED_COPY9]](s32), [[FRAME_INDEX37]](p5) :: (store (s32) into %fixed-stack.0, align 16, addrspace 5)
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr3 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr4 = PRED_COPY [[C1]](s32)
  ; GCN-NEXT:   $vgpr5 = PRED_COPY [[C1]](s32)
...
define hidden fastcc i64 @sibling_call_i64_fastcc_i64(i64 %a) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(s32) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(s64) = G_MERGE_VALUES [[PRED_COPY9]](s32), [[PRED_COPY10]](s32)
  ; GCN-NEXT:   [[GV:%[0-9]+]]:sreg_64(p0) = G_GLOBAL_VALUE @i64_fastcc_i64
  ; GCN-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]]
  ; GCN-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; GCN-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; GCN-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY5]]
  ; GCN-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GCN-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GCN-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[UV]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[UV1]](s32)
  ; GCN-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; GCN-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY11]](p4)
  ; GCN-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY12]](p4)
  ; GCN-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PRED_COPY13]](p4)
  ; GCN-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY14]](s64)
  ; GCN-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY15]](s32)
  ; GCN-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY16]](s32)
  ; GCN-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY17]](s32)
  ; GCN-NEXT:   $sgpr15 = PRED_COPY [[PRED_COPY18]](s32)
  ; GCN-NEXT:   $vgpr31 = PRED_COPY [[PRED_COPY19]](s32)
...
define hidden fastcc i8 addrspace(1)* @sibling_call_p1i8_fastcc_p1i8(i8 addrspace(1)* %a) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(s32) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(p1) = G_MERGE_VALUES [[PRED_COPY9]](s32), [[PRED_COPY10]](s32)
...
define hidden fastcc i16 @sibling_call_i16_fastcc_i16(i16 %a) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY8:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; GCN-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   [[TRUNC:%[0-9]+]]:_(s16) = G_TRUNC [[PRED_COPY9]](s32)
  ...
  ; GCN-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; GCN-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY5]]
  ; GCN-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GCN-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GCN-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ; GCN-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   [[ANYEXT:%[0-9]+]]:_(s32) = G_ANYEXT [[TRUNC]](s16)
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[ANYEXT]](s32)
  ; GCN-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY19]](<4 x s32>)
  ; GCN-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; GCN-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
  ; GCN-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PRED_COPY12]](p4)
  ...
  ; GCN-NEXT:   $sgpr15 = PRED_COPY [[PRED_COPY17]](s32)
  ; GCN-NEXT:   $vgpr31 = PRED_COPY [[PRED_COPY18]](s32)
...
define hidden fastcc <3 x i16> @sibling_call_v3i16_fastcc_v3i16(<3 x i16> %a) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; GCN-NEXT:   [[PRED_COPY8:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; GCN-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(<2 x s16>) = PRED_COPY $vgpr0
  ; GCN-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(<2 x s16>) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[CONCAT_VECTORS:%[0-9]+]]:_(<4 x s16>) = G_CONCAT_VECTORS [[PRED_COPY9]](<2 x s16>), [[PRED_COPY10]](<2 x s16>)
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[UV7]](<2 x s16>)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[UV8]](<2 x s16>)
  ; GCN-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; GCN-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY11]](p4)
  ; GCN-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY12]](p4)
...
define hidden fastcc <4 x i16> @sibling_call_v4i16_fastcc_v4i16(<4 x i16> %a) #1 {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[UV]](<2 x s16>)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[UV1]](<2 x s16>)
  ; GCN-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; GCN-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY11]](p4)
  ; GCN-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY12]](p4)
...
define hidden fastcc <2 x i64> @sibling_call_v2i64_fastcc_v2i64(<2 x i64> %a) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(s32) = PRED_COPY $vgpr3
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(s64) = G_MERGE_VALUES [[PRED_COPY9]](s32), [[PRED_COPY10]](s32)
  ; GCN-NEXT:   [[MV1:%[0-9]+]]:_(s64) = G_MERGE_VALUES [[PRED_COPY11]](s32), [[PRED_COPY12]](s32)
  ...
  ; GCN-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]]
  ; GCN-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; GCN-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; GCN-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY5]]
  ; GCN-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GCN-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GCN-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ; GCN-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   [[PRED_COPY21:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   [[UV:%[0-9]+]]:_(s32), [[UV1:%[0-9]+]]:_(s32), [[UV2:%[0-9]+]]:_(s32), [[UV3:%[0-9]+]]:_(s32) = G_UNMERGE_VALUES [[BUILD_VECTOR]](<2 x s64>)
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[UV]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[UV1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[UV2]](s32)
  ; GCN-NEXT:   $vgpr3 = PRED_COPY [[UV3]](s32)
  ; GCN-NEXT:   [[PRED_COPY22:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY22]](<4 x s32>)
  ; GCN-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY13]](p4)
  ; GCN-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY14]](p4)
  ; GCN-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PRED_COPY15]](p4)
  ; GCN-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY16]](s64)
  ; GCN-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY17]](s32)
  ; GCN-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY18]](s32)
  ; GCN-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY19]](s32)
  ; GCN-NEXT:   $sgpr15 = PRED_COPY [[PRED_COPY20]](s32)
  ; GCN-NEXT:   $vgpr31 = PRED_COPY [[PRED_COPY21]](s32)
