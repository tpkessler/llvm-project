...
define amdgpu_kernel void @test_call_external_void_func_i32([17 x i8]) #0 {
  ...
  ; GFX900-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr16
  ; GFX900-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr15
  ; GFX900-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr14
  ; GFX900-NEXT:   [[PRED_COPY6:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr10_sgpr11
  ; GFX900-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; GFX900-NEXT:   [[PRED_COPY8:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; GFX900-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p4) = PRED_COPY $sgpr8_sgpr9
  ...
  ; GFX900-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]]
  ; GFX900-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; GFX900-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY9]](p4)
  ; GFX900-NEXT:   [[C1:%[0-9]+]]:_(s64) = G_CONSTANT i64 20
  ; GFX900-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C1]](s64)
  ; GFX900-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; GFX900-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; GFX900-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GFX900-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GFX900-NEXT:   [[DEF:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ; GFX900-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]](s32)
  ; GFX900-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; GFX900-NEXT:   [[C2:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX900-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C2]](s32)
  ; GFX900-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; GFX900-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GFX900-NEXT:   [[C3:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; GFX900-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C3]](s32)
  ; GFX900-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
  ; GFX900-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
  ; GFX900-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; GFX900-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; GFX900-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; GFX900-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
  ; GFX900-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PTR_ADD]](p4)
  ; GFX900-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY13]](s64)
  ; GFX900-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY14]](s32)
  ; GFX900-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY15]](s32)
  ; GFX900-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY16]](s32)
  ; GFX900-NEXT:   $sgpr15 = PRED_COPY [[DEF]](s32)
  ...
  ; GFX908-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr16
  ; GFX908-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr15
  ; GFX908-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr14
  ; GFX908-NEXT:   [[PRED_COPY6:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr10_sgpr11
  ; GFX908-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; GFX908-NEXT:   [[PRED_COPY8:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; GFX908-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p4) = PRED_COPY $sgpr8_sgpr9
  ...
  ; GFX908-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]]
  ; GFX908-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; GFX908-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY9]](p4)
  ; GFX908-NEXT:   [[C1:%[0-9]+]]:_(s64) = G_CONSTANT i64 20
  ; GFX908-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C1]](s64)
  ; GFX908-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; GFX908-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; GFX908-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GFX908-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GFX908-NEXT:   [[DEF:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ; GFX908-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]](s32)
  ; GFX908-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; GFX908-NEXT:   [[C2:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX908-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C2]](s32)
  ; GFX908-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; GFX908-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GFX908-NEXT:   [[C3:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; GFX908-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C3]](s32)
  ; GFX908-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
  ; GFX908-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
  ; GFX908-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; GFX908-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; GFX908-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; GFX908-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
  ; GFX908-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PTR_ADD]](p4)
  ; GFX908-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY13]](s64)
  ; GFX908-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY14]](s32)
  ; GFX908-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY15]](s32)
  ; GFX908-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY16]](s32)
  ; GFX908-NEXT:   $sgpr15 = PRED_COPY [[DEF]](s32)
...
define void @test_func_call_external_void_func_i32() #0 {
  ...
  ; GFX900-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ...
  ; GFX908-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
...
define void @test_func_call_external_void_func_v32i32([17 x i8]) #0 {
  ...
  ; GFX900-NEXT:   [[PRED_COPY27:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ...
  ; GFX908-NEXT:   [[PRED_COPY27:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
...
define amdgpu_kernel void @test_only_workitem_id_x() #0 !reqd_work_group_size !0 {
  ...
  ; GFX900-NEXT:   [[PRED_COPY1:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr16
  ; GFX900-NEXT:   [[PRED_COPY2:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr15
  ; GFX900-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr14
  ; GFX900-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr10_sgpr11
  ; GFX900-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; GFX900-NEXT:   [[PRED_COPY6:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; GFX900-NEXT:   [[PRED_COPY7:%[0-9]+]]:_(p4) = PRED_COPY $sgpr8_sgpr9
  ; GFX900-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 42
  ; GFX900-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GFX900-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_i32
  ; GFX900-NEXT:   [[PRED_COPY8:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; GFX900-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY5]]
  ...
  ; GFX900-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY4]]
  ; GFX900-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GFX900-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ; GFX900-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]]
  ; GFX900-NEXT:   [[DEF:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ...
  ; GFX900-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY9]](p4)
  ; GFX900-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PTR_ADD]](p4)
  ...
  ; GFX900-NEXT:   $sgpr15 = PRED_COPY [[DEF]](s32)
  ; GFX900-NEXT:   $vgpr31 = PRED_COPY [[PRED_COPY15]](s32)
  ; GFX900-NEXT:   $sgpr30_sgpr31 = G_SI_CALL [[GV]](p0), @external_void_func_i32, csr_amdgpu, implicit $vgpr0, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit $sgpr4_sgpr5, implicit $sgpr6_sgpr7, implicit $sgpr8_sgpr9, implicit $sgpr10_sgpr11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31
  ; GFX900-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GFX900-NEXT:   S_ENDPGM 0
  ...
  ; GFX908-NEXT:   [[PRED_COPY1:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr16
  ; GFX908-NEXT:   [[PRED_COPY2:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr15
  ; GFX908-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr14
  ; GFX908-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr10_sgpr11
  ; GFX908-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; GFX908-NEXT:   [[PRED_COPY6:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; GFX908-NEXT:   [[PRED_COPY7:%[0-9]+]]:_(p4) = PRED_COPY $sgpr8_sgpr9
  ; GFX908-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 42
  ; GFX908-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GFX908-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_i32
  ; GFX908-NEXT:   [[PRED_COPY8:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; GFX908-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY5]]
  ...
  ; GFX908-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY4]]
  ; GFX908-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GFX908-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ; GFX908-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]]
  ; GFX908-NEXT:   [[DEF:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ...
  ; GFX908-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY9]](p4)
  ; GFX908-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PTR_ADD]](p4)
  ...
  ; GFX908-NEXT:   $sgpr15 = PRED_COPY [[DEF]](s32)
  ; GFX908-NEXT:   $vgpr31 = PRED_COPY [[PRED_COPY15]](s32)
  ; GFX908-NEXT:   $sgpr30_sgpr31 = G_SI_CALL [[GV]](p0), @external_void_func_i32, csr_amdgpu, implicit $vgpr0, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit $sgpr4_sgpr5, implicit $sgpr6_sgpr7, implicit $sgpr8_sgpr9, implicit $sgpr10_sgpr11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31
  ; GFX908-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GFX908-NEXT:   S_ENDPGM 0
  call void @external_void_func_i32(i32 42)
...
define amdgpu_kernel void @test_only_workitem_id_y() #0 !reqd_work_group_size !1 {
  ...
  ; GFX900-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY15]], [[C3]](s32)
  ...
  ; GFX908-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY15]], [[C3]](s32)
...
define amdgpu_kernel void @test_only_workitem_id_xy() #0 !reqd_work_group_size !3 {
  ...
  ; GFX900-NEXT:   [[PRED_COPY2:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr16
  ; GFX900-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr15
  ; GFX900-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr14
  ; GFX900-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr10_sgpr11
  ; GFX900-NEXT:   [[PRED_COPY6:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; GFX900-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; GFX900-NEXT:   [[PRED_COPY8:%[0-9]+]]:_(p4) = PRED_COPY $sgpr8_sgpr9
  ; GFX900-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 42
  ; GFX900-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GFX900-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_i32
  ; GFX900-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; GFX900-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; GFX900-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]](p4)
  ; GFX900-NEXT:   [[C1:%[0-9]+]]:_(s64) = G_CONSTANT i64 0
  ; GFX900-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY11]], [[C1]](s64)
  ; GFX900-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY5]]
  ; GFX900-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GFX900-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GFX900-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ...
  ; GFX900-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GFX900-NEXT:   [[C2:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX900-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY17]], [[C2]](s32)
  ; GFX900-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY16]], [[SHL]]
  ; GFX900-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
  ...
  ; GFX908-NEXT:   [[PRED_COPY2:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr16
  ; GFX908-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr15
  ; GFX908-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr14
  ; GFX908-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr10_sgpr11
  ; GFX908-NEXT:   [[PRED_COPY6:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; GFX908-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; GFX908-NEXT:   [[PRED_COPY8:%[0-9]+]]:_(p4) = PRED_COPY $sgpr8_sgpr9
  ; GFX908-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 42
  ; GFX908-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GFX908-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_i32
  ; GFX908-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; GFX908-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; GFX908-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]](p4)
  ; GFX908-NEXT:   [[C1:%[0-9]+]]:_(s64) = G_CONSTANT i64 0
  ; GFX908-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY11]], [[C1]](s64)
  ; GFX908-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY5]]
  ; GFX908-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GFX908-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GFX908-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ...
  ; GFX908-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GFX908-NEXT:   [[C2:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX908-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY17]], [[C2]](s32)
  ; GFX908-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY16]], [[SHL]]
  ; GFX908-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
...
define amdgpu_kernel void @test_only_workitem_id_yz() #0 !reqd_work_group_size !4 {
  ...
  ; GFX900-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; GFX900-NEXT:   [[C3:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX900-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY16]], [[C3]](s32)
  ; GFX900-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[C2]], [[SHL]]
  ; GFX900-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GFX900-NEXT:   [[C4:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; GFX900-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY17]], [[C4]](s32)
  ; GFX900-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
  ; GFX900-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
  ; GFX900-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; GFX900-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY18]](<4 x s32>)
  ...
  ; GFX908-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; GFX908-NEXT:   [[C3:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX908-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY16]], [[C3]](s32)
  ; GFX908-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[C2]], [[SHL]]
  ; GFX908-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GFX908-NEXT:   [[C4:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; GFX908-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY17]], [[C4]](s32)
  ; GFX908-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
  ; GFX908-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
  ; GFX908-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; GFX908-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY18]](<4 x s32>)
