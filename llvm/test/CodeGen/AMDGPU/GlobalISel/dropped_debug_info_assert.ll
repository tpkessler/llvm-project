...
define void @returnaddress_debug_loc(i8* addrspace(1)* %ptr) {
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:sreg_64 = PRED_COPY $sgpr30_sgpr31, debug-location !6
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:vgpr_32 = PRED_COPY $vgpr0
  ; CHECK-NEXT:   [[PRED_COPY2:%[0-9]+]]:vgpr_32 = PRED_COPY $vgpr1
  ; CHECK-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:vreg_64 = REG_SEQUENCE [[PRED_COPY1]], %subreg.sub0, [[PRED_COPY2]], %subreg.sub1
  ; CHECK-NEXT:   [[PRED_COPY3:%[0-9]+]]:vreg_64 = PRED_COPY [[PRED_COPY]]
  ; CHECK-NEXT:   GLOBAL_STORE_DWORDX2 [[REG_SEQUENCE]], [[PRED_COPY3]], 0, 0, implicit $exec :: (store (p0) into %ir.ptr, addrspace 1)
