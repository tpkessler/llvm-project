...
define amdgpu_ps float @image_load_f32(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; GCN-NEXT: {{  $}}
  ; GCN-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY $sgpr2
  ; GCN-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s32) = PRED_COPY $sgpr3
  ; GCN-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(s32) = PRED_COPY $sgpr4
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:_(s32) = PRED_COPY $sgpr5
  ; GCN-NEXT:   [[PRED_COPY4:%[0-9]+]]:_(s32) = PRED_COPY $sgpr6
  ; GCN-NEXT:   [[PRED_COPY5:%[0-9]+]]:_(s32) = PRED_COPY $sgpr7
  ; GCN-NEXT:   [[PRED_COPY6:%[0-9]+]]:_(s32) = PRED_COPY $sgpr8
  ; GCN-NEXT:   [[PRED_COPY7:%[0-9]+]]:_(s32) = PRED_COPY $sgpr9
  ; GCN-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<8 x s32>) = G_BUILD_VECTOR [[PRED_COPY]](s32), [[PRED_COPY1]](s32), [[PRED_COPY2]](s32), [[PRED_COPY3]](s32), [[PRED_COPY4]](s32), [[PRED_COPY5]](s32), [[PRED_COPY6]](s32), [[PRED_COPY7]](s32)
  ; GCN-NEXT:   [[PRED_COPY8:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(s32) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:_(<2 x s32>) = G_BUILD_VECTOR [[PRED_COPY8]](s32), [[PRED_COPY9]](s32)
...
define amdgpu_ps float @image_load_f32_dmask_0000(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[DEF]](s32)
  ; GCN-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
...
define amdgpu_ps <2 x float> @image_load_v2f32_dmask_1000(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; GCN-NEXT:   [[DEF:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[AMDGPU_INTRIN_IMAGE_LOAD]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[DEF]](s32)
  ; GCN-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0, implicit $vgpr1
...
define amdgpu_ps <3 x float> @image_load_v3f32_dmask_1100(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[UV]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[UV1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[DEF]](s32)
  ; GCN-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0, implicit $vgpr1, implicit $vgpr2
...
define amdgpu_ps <4 x float> @image_load_v4f32_dmask_1110(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[UV1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[UV2]](s32)
  ; GCN-NEXT:   $vgpr3 = PRED_COPY [[DEF]](s32)
  ; GCN-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0, implicit $vgpr1, implicit $vgpr2, implicit $vgpr3
...
define amdgpu_ps <2 x float> @image_load_tfe_v2f32_dmask_1000(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; GCN-NEXT:   G_STORE [[UV1]](s32), [[DEF]](p1) :: (store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[UV]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[DEF1]](s32)
  ; GCN-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0, implicit $vgpr1
...
define amdgpu_ps <3 x float> @image_load_tfe_v3f32_dmask_1100(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[UV]](s32)
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[UV1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[DEF1]](s32)
  ; GCN-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0, implicit $vgpr1, implicit $vgpr2
...
define amdgpu_ps <4 x float> @image_load_tfe_v4f32_dmask_1110(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; GCN-NEXT:   $vgpr1 = PRED_COPY [[UV1]](s32)
  ; GCN-NEXT:   $vgpr2 = PRED_COPY [[UV2]](s32)
  ; GCN-NEXT:   $vgpr3 = PRED_COPY [[DEF1]](s32)
  ; GCN-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0, implicit $vgpr1, implicit $vgpr2, implicit $vgpr3
