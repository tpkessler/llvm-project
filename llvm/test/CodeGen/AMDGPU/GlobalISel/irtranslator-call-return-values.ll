...
define amdgpu_kernel void @test_call_external_i32_func_i32_imm(i32 addrspace(1)* %out) #0 {
  ...
  ; GCN-NEXT:   [[LOAD:%[0-9]+]]:_(p1) = G_LOAD [[INT]](p4) :: (dereferenceable invariant load (p1) from %ir.out.kernarg.offset.cast, align 16, addrspace 4)
...
define amdgpu_kernel void @test_call_external_i32_func_void() #0 {
  ...
  ; GCN-NEXT:   [[PRED_COPY21:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[PRED_COPY21]](s32), [[DEF]](p1) :: (volatile store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_gfx void @test_gfx_call_external_i32_func_void() #0 {
  ...
  ; GCN-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[PRED_COPY1]](s32), [[DEF]](p1) :: (volatile store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   SI_RETURN
...
define amdgpu_kernel void @test_call_external_i48_zeroext_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[ZEXT]](s64), [[DEF]](p1) :: (volatile store (s64) into `i64 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i48_signext_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[SEXT]](s64), [[DEF]](p1) :: (volatile store (s64) into `i64 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_p3_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[PRED_COPY21]](p3), [[DEF]](p3) :: (volatile store (p3) into `i8 addrspace(3)* addrspace(3)* undef`, addrspace 3)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_f32_func_void() #0 {
  ...
  ; GCN-NEXT:   [[PRED_COPY21:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[PRED_COPY21]](s32), [[DEF]](p1) :: (volatile store (s32) into `float addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v2i16_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[PRED_COPY21]](<2 x s16>), [[DEF]](p1) :: (volatile store (<2 x s16>) into `<2 x i16> addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v2f16_func_void() #0 {
  ...
  ; GCN-NEXT:   [[PRED_COPY21:%[0-9]+]]:_(<2 x s16>) = PRED_COPY $vgpr0
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[PRED_COPY21]](<2 x s16>), [[DEF]](p1) :: (volatile store (<2 x s16>) into `<2 x half> addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i32_i64_func_void() #0 {
  ...
  ; GCN-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p4) = PRED_COPY $sgpr8_sgpr9
  ; GCN-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; GCN-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p1) = PRED_COPY [[DEF]](p1)
  ; GCN-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ...
  ; GCN-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY9]](p4)
  ; GCN-NEXT:   [[C:%[0-9]+]]:_(s64) = G_CONSTANT i64 0
  ; GCN-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY13]], [[C]](s64)
  ; GCN-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; GCN-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; GCN-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; GCN-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; GCN-NEXT:   [[DEF1:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ; GCN-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]](s32)
  ; GCN-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; GCN-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GCN-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C1]](s32)
  ; GCN-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY18]], [[SHL]]
  ; GCN-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; GCN-NEXT:   [[C2:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; GCN-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY20]], [[C2]](s32)
  ; GCN-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
  ; GCN-NEXT:   [[PRED_COPY21:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY21]](<4 x s32>)
  ...
  ; GCN-NEXT:   [[PRED_COPY22:%[0-9]+]]:_(s32) = PRED_COPY $vgpr0
  ; GCN-NEXT:   [[PRED_COPY23:%[0-9]+]]:_(s32) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[PRED_COPY24:%[0-9]+]]:_(s32) = PRED_COPY $vgpr2
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(s64) = G_MERGE_VALUES [[PRED_COPY23]](s32), [[PRED_COPY24]](s32)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[PRED_COPY22]](s32), [[DEF]](p1) :: (volatile store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[MV]](s64), [[PRED_COPY10]](p1) :: (volatile store (s64) into `i64 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_gfx void @test_gfx_call_external_i32_i64_func_void() #0 {
  ...
  ; GCN: bb.1 (%ir-block.0):
  ; GCN-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; GCN-NEXT:   [[PRED_COPY:%[0-9]+]]:_(p1) = PRED_COPY [[DEF]](p1)
  ; GCN-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GCN-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_gfx_i32_i64_func_void
  ; GCN-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ...
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:_(s32) = PRED_COPY $vgpr1
  ; GCN-NEXT:   [[PRED_COPY4:%[0-9]+]]:_(s32) = PRED_COPY $vgpr2
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(s64) = G_MERGE_VALUES [[PRED_COPY3]](s32), [[PRED_COPY4]](s32)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[PRED_COPY2]](s32), [[DEF]](p1) :: (volatile store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[MV]](s64), [[PRED_COPY]](p1) :: (volatile store (s64) into `i64 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   SI_RETURN
...
define amdgpu_kernel void @test_call_external_a5i8_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[TRUNC1]](s8), [[DEF]](p1) :: (volatile store (s8) into `i8 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[TRUNC3]](s8), [[DEF]](p1) :: (volatile store (s8) into `i8 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[TRUNC5]](s8), [[DEF]](p1) :: (volatile store (s8) into `i8 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[TRUNC7]](s8), [[DEF]](p1) :: (volatile store (s8) into `i8 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[TRUNC9]](s8), [[DEF]](p1) :: (volatile store (s8) into `i8 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v32i32_i32_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[LOAD1]](s32), [[PRED_COPY10]](p1) :: (volatile store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i32_v32i32_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[LOAD1]](<32 x s32>), [[PRED_COPY10]](p1) :: (volatile store (<32 x s32>) into `<32 x i32> addrspace(1)* undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v33i32_func_v33i32_i32(<33 x i32> addrspace(1)* %p, i32 %idx) #0 {
  ...
  ; GCN-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; GCN-NEXT:   [[INT:%[0-9]+]]:_(p4) = G_INTRINSIC intrinsic(@llvm.amdgcn.kernarg.segment.ptr)
  ; GCN-NEXT:   [[LOAD:%[0-9]+]]:_(p1) = G_LOAD [[INT]](p4) :: (dereferenceable invariant load (p1) from %ir.p.kernarg.offset.cast, align 16, addrspace 4)
  ; GCN-NEXT:   [[C:%[0-9]+]]:_(s64) = G_CONSTANT i64 8
  ; GCN-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[INT]], [[C]](s64)
  ; GCN-NEXT:   [[LOAD1:%[0-9]+]]:_(s32) = G_LOAD [[PTR_ADD]](p4) :: (dereferenceable invariant load (s32) from %ir.idx.kernarg.offset.cast, align 8, addrspace 4)
  ; GCN-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p5) = G_FRAME_INDEX %stack.0
  ; GCN-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
