...
define i32 @asm_vgpr_early_clobber() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 7; v_mov_b32 $1, 7", 1 /* sideeffect attdialect */, 1966091 /* regdef-ec:VGPR_32 */, def early-clobber %0, 1966091 /* regdef-ec:VGPR_32 */, def early-clobber %1, !0
...
define i32 @test_single_vgpr_output() nounwind {
  ...
  ; CHECK: bb.1.entry:
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 7", 0 /* attdialect */, 1966090 /* regdef:VGPR_32 */, def %0
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %0
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
...
define i32 @test_single_sgpr_output_s32() nounwind {
  ...
  ; CHECK: bb.1.entry:
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 7", 0 /* attdialect */, 2097162 /* regdef:SReg_32 */, def %0
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %0
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
...
define float @test_multiple_register_outputs_same() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 0; v_mov_b32 $1, 1", 0 /* attdialect */, 1966090 /* regdef:VGPR_32 */, def %0, 1966090 /* regdef:VGPR_32 */, def %1
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %0
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s32) = PRED_COPY %1
...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 0; v_add_f64 $1, 0, 0", 0 /* attdialect */, 1966090 /* regdef:VGPR_32 */, def %0, 3211274 /* regdef:VReg_64 */, def %1
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %0
...
define amdgpu_kernel void @test_input_vgpr_imm() {
  ...
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 v0, $0", 1 /* sideeffect attdialect */, 1966089 /* reguse:VGPR_32 */, [[PRED_COPY]]
  ; CHECK-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_input_sgpr_imm() {
  ...
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 s0, $0", 1 /* sideeffect attdialect */, 2097161 /* reguse:SReg_32 */, [[PRED_COPY]]
  ; CHECK-NEXT:   S_ENDPGM 0
...
define float @test_input_vgpr(i32 %src) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"v_add_f32 $0, 1.0, $1", 0 /* attdialect */, 1966090 /* regdef:VGPR_32 */, def %1, 1966089 /* reguse:VGPR_32 */, [[PRED_COPY1]]
...
define i32 @test_memory_constraint(i32 addrspace(3)* %a) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"ds_read_b32 $0, $1", 8 /* mayload attdialect */, 1966090 /* regdef:VGPR_32 */, def %1, 196622 /* mem:m */, [[PRED_COPY]](p3)
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s32) = PRED_COPY %1
...
define i32 @test_vgpr_matching_constraint(i32 %a) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &";", 1 /* sideeffect attdialect */, 1966090 /* regdef:VGPR_32 */, def %3, 2147483657 /* reguse tiedto:$0 */, [[PRED_COPY1]](tied-def 3)
...
define i32 @test_sgpr_matching_constraint() nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 7", 0 /* attdialect */, 2097162 /* regdef:SReg_32 */, def %0
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %0
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 8", 0 /* attdialect */, 2097162 /* regdef:SReg_32 */, def %2
  ...
  ; CHECK-NEXT:   INLINEASM &"s_add_u32 $0, $1, $2", 0 /* attdialect */, 2097162 /* regdef:SReg_32 */, def %4, 2097161 /* reguse:SReg_32 */, [[PRED_COPY2]], 2147483657 /* reguse tiedto:$0 */, [[PRED_COPY3]](tied-def 3)
...
define void @test_many_matching_constraints(i32 %a, i32 %b, i32 %c) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"; ", 1 /* sideeffect attdialect */, 1966090 /* regdef:VGPR_32 */, def %3, 1966090 /* regdef:VGPR_32 */, def %4, 1966090 /* regdef:VGPR_32 */, def %5, 2147483657 /* reguse tiedto:$0 */, [[PRED_COPY3]](tied-def 3), 2147614729 /* reguse tiedto:$2 */, [[PRED_COPY4]](tied-def 7), 2147549193 /* reguse tiedto:$1 */, [[PRED_COPY5]](tied-def 5)
  ...
  ; CHECK-NEXT:   G_STORE [[PRED_COPY6]](s32), [[DEF]](p1) :: (store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
  ; CHECK-NEXT:   G_STORE [[PRED_COPY7]](s32), [[DEF]](p1) :: (store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
  ; CHECK-NEXT:   G_STORE [[PRED_COPY8]](s32), [[DEF]](p1) :: (store (s32) into `i32 addrspace(1)* undef`, addrspace 1)
...
define i32 @test_sgpr_to_vgpr_move_matching_constraint() nounwind {
  ...
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %0
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:vgpr_32 = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, $1", 0 /* attdialect */, 1966090 /* regdef:VGPR_32 */, def %2, 2147483657 /* reguse tiedto:$0 */, [[PRED_COPY1]](tied-def 3)
