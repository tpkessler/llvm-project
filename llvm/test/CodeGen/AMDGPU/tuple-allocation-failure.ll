...
; GLOBALNESS1-NEXT:    s_load_dwordx4 s[84:87], s[6:7], 0x0
...
; GLOBALNESS1-NEXT:    global_load_dword v0, v40, s[84:85]
...
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s86, 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[90:91], -1, 0
; GLOBALNESS1-NEXT:    s_xor_b64 s[92:93], s[90:91], -1
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v41, 0x40994400
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    v_cmp_ngt_f64_e64 s[40:41], s[4:5], v[40:41]
; GLOBALNESS1-NEXT:    v_cmp_ngt_f64_e64 s[88:89], s[4:5], 0
...
; GLOBALNESS1-NEXT:    s_mov_b32 s58, s14
; GLOBALNESS1-NEXT:    s_mov_b32 s59, s13
; GLOBALNESS1-NEXT:    s_mov_b32 s60, s12
; GLOBALNESS1-NEXT:    s_mov_b64 s[34:35], s[8:9]
; GLOBALNESS1-NEXT:    s_mov_b64 s[62:63], 0x80
; GLOBALNESS1-NEXT:    s_xor_b64 s[96:97], s[4:5], -1
; GLOBALNESS1-NEXT:    s_mov_b32 s65, 0x3ff00000
...
; GLOBALNESS1-NEXT:    v_cmp_gt_i32_e64 s[42:43], 0, v0
; GLOBALNESS1-NEXT:    v_cmp_gt_i32_e64 s[44:45], 1, v0
; GLOBALNESS1-NEXT:    v_cmp_eq_u32_e64 s[46:47], 1, v0
; GLOBALNESS1-NEXT:    v_cmp_eq_u32_e64 s[48:49], 0, v0
...
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[0:1], s[62:63], s[62:63] op_sel:[0,1]
...
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s60
; GLOBALNESS1-NEXT:    s_mov_b32 s13, s59
; GLOBALNESS1-NEXT:    s_mov_b32 s14, s58
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lt_i32 s87, 1
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_7
; GLOBALNESS1-NEXT:  ; %bb.6: ; %LeafBlock3
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s87, 1
...
; GLOBALNESS1-NEXT:    s_mov_b32 s64, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s66, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s67, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s68, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s69, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s70, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s71, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s72, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s73, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s74, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s75, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s76, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s77, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s78, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s79, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s80, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s81, s65
; GLOBALNESS1-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GLOBALNESS1-NEXT:    v_cmp_gt_i32_e64 s[50:51], 0, v0
...
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[66:67], s[50:51]
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v44
; GLOBALNESS1-NEXT:    v_cndmask_b32_e32 v2, 0, v43, vcc
; GLOBALNESS1-NEXT:    s_waitcnt vmcnt(0)
; GLOBALNESS1-NEXT:    v_cmp_nlt_f64_e64 s[52:53], 0, v[0:1]
; GLOBALNESS1-NEXT:    v_cmp_eq_u32_e64 s[54:55], 0, v2
...
; GLOBALNESS1-NEXT:    s_andn2_b64 vcc, exec, s[92:93]
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_15 Depth=2
; GLOBALNESS1-NEXT:    s_add_u32 s56, s38, 40
; GLOBALNESS1-NEXT:    s_addc_u32 s57, s39, 0
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[36:37]
; GLOBALNESS1-NEXT:    s_mov_b64 s[8:9], s[56:57]
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], s[34:35]
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s60
; GLOBALNESS1-NEXT:    s_mov_b32 s13, s59
; GLOBALNESS1-NEXT:    s_mov_b32 s14, s58
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s87, 0
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_mov_b32 s68, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s69, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s70, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s71, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s72, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s73, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s74, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s75, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s76, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s77, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s78, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s79, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s80, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s81, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s82, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s83, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s84, s63
; GLOBALNESS1-NEXT:    s_mov_b32 s85, s63
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_or_b64 exec, exec, s[66:67]
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[4:5], s[50:51]
...
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[60:63], s[6:7], 0x0
...
; GLOBALNESS0-NEXT:    global_load_dword v0, v40, s[60:61]
...
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s62, 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[90:91], -1, 0
; GLOBALNESS0-NEXT:    s_xor_b64 s[92:93], s[90:91], -1
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v41, 0x40994400
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    v_cmp_ngt_f64_e64 s[40:41], s[4:5], v[40:41]
; GLOBALNESS0-NEXT:    v_cmp_ngt_f64_e64 s[88:89], s[4:5], 0
...
; GLOBALNESS0-NEXT:    s_mov_b32 s57, s13
; GLOBALNESS0-NEXT:    s_mov_b32 s58, s12
; GLOBALNESS0-NEXT:    s_mov_b64 s[34:35], s[8:9]
; GLOBALNESS0-NEXT:    s_mov_b64 s[86:87], 0x80
; GLOBALNESS0-NEXT:    s_xor_b64 s[96:97], s[4:5], -1
; GLOBALNESS0-NEXT:    s_mov_b32 s65, 0x3ff00000
...
; GLOBALNESS0-NEXT:    v_cmp_gt_i32_e64 s[42:43], 0, v0
; GLOBALNESS0-NEXT:    v_cmp_gt_i32_e64 s[44:45], 1, v0
; GLOBALNESS0-NEXT:    v_cmp_eq_u32_e64 s[46:47], 1, v0
; GLOBALNESS0-NEXT:    v_cmp_eq_u32_e64 s[48:49], 0, v0
...
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[0:1], s[86:87], s[86:87] op_sel:[0,1]
...
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s58
; GLOBALNESS0-NEXT:    s_mov_b32 s13, s57
; GLOBALNESS0-NEXT:    s_mov_b32 s14, s56
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lt_i32 s63, 1
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_7
; GLOBALNESS0-NEXT:  ; %bb.6: ; %LeafBlock3
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s63, 1
...
; GLOBALNESS0-NEXT:    s_mov_b32 s64, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s66, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s67, s65
; GLOBALNESS0-NEXT:    s_mov_b32 s68, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s69, s65
; GLOBALNESS0-NEXT:    s_mov_b32 s70, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s71, s65
; GLOBALNESS0-NEXT:    s_mov_b32 s72, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s73, s65
; GLOBALNESS0-NEXT:    s_mov_b32 s74, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s75, s65
; GLOBALNESS0-NEXT:    s_mov_b32 s76, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s77, s65
; GLOBALNESS0-NEXT:    s_mov_b32 s78, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s79, s65
; GLOBALNESS0-NEXT:    s_mov_b32 s80, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s81, s65
; GLOBALNESS0-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GLOBALNESS0-NEXT:    v_cmp_gt_i32_e64 s[50:51], 0, v0
...
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[66:67], s[50:51]
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v44
; GLOBALNESS0-NEXT:    v_cndmask_b32_e32 v2, 0, v43, vcc
; GLOBALNESS0-NEXT:    s_waitcnt vmcnt(0)
; GLOBALNESS0-NEXT:    v_cmp_nlt_f64_e64 s[52:53], 0, v[0:1]
; GLOBALNESS0-NEXT:    v_cmp_eq_u32_e64 s[54:55], 0, v2
...
; GLOBALNESS0-NEXT:    s_andn2_b64 vcc, exec, s[92:93]
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_15 Depth=2
; GLOBALNESS0-NEXT:    s_add_u32 s60, s38, 40
; GLOBALNESS0-NEXT:    s_addc_u32 s61, s39, 0
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[36:37]
; GLOBALNESS0-NEXT:    s_mov_b64 s[8:9], s[60:61]
; GLOBALNESS0-NEXT:    s_mov_b64 s[10:11], s[34:35]
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s58
; GLOBALNESS0-NEXT:    s_mov_b32 s13, s57
; GLOBALNESS0-NEXT:    s_mov_b32 s14, s56
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s63, 0
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_mov_b32 s68, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s69, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s70, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s71, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s72, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s73, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s74, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s75, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s76, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s77, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s78, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s79, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s80, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s81, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s82, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s83, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s84, s87
; GLOBALNESS0-NEXT:    s_mov_b32 s85, s87
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_or_b64 exec, exec, s[66:67]
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[4:5], s[50:51]
