...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_mov_b32 s0, s4
; VI-NEXT:    s_ff1_i32_b32 s4, s7
; VI-NEXT:    s_add_i32 s4, s4, 32
; VI-NEXT:    s_mov_b32 s1, s5
; VI-NEXT:    s_ff1_i32_b32 s5, s6
...
; VI-NEXT:    v_or_b32_sdwa v1, v3, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v0, v1, v0
; VI-NEXT:    v_ffbl_b32_e32 v1, v0
...
; SI-NEXT:    buffer_load_ubyte v3, off, s[8:11], 0 offset:2
; SI-NEXT:    buffer_load_ubyte v4, off, s[8:11], 0 offset:3
; SI-NEXT:    buffer_load_ubyte v5, off, s[8:11], 0 offset:4
; SI-NEXT:    buffer_load_ubyte v6, off, s[8:11], 0 offset:5
; SI-NEXT:    buffer_load_ubyte v7, off, s[8:11], 0 offset:7
; SI-NEXT:    buffer_load_ubyte v8, off, s[8:11], 0 offset:6
; SI-NEXT:    v_mov_b32_e32 v1, 0
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_waitcnt vmcnt(2)
...
; VI-NEXT:    buffer_load_ubyte v3, off, s[8:11], 0 offset:2
; VI-NEXT:    buffer_load_ubyte v4, off, s[8:11], 0 offset:3
; VI-NEXT:    buffer_load_ubyte v5, off, s[8:11], 0 offset:4
; VI-NEXT:    buffer_load_ubyte v6, off, s[8:11], 0 offset:5
; VI-NEXT:    buffer_load_ubyte v7, off, s[8:11], 0 offset:6
; VI-NEXT:    buffer_load_ubyte v8, off, s[8:11], 0 offset:7
; VI-NEXT:    v_mov_b32_e32 v1, 0
; VI-NEXT:    s_mov_b32 s0, s4
; VI-NEXT:    s_mov_b32 s1, s5
...
; VI-NEXT:    v_or_b32_sdwa v2, v4, v3 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    s_waitcnt vmcnt(2)
; VI-NEXT:    v_lshlrev_b32_e32 v6, 8, v6
; VI-NEXT:    v_or_b32_e32 v5, v6, v5
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_lshlrev_b32_e32 v8, 8, v8
; VI-NEXT:    v_or_b32_sdwa v6, v8, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v3, v6, v5
; VI-NEXT:    v_or_b32_e32 v2, v2, v0
; VI-NEXT:    v_ffbl_b32_e32 v0, v3
; VI-NEXT:    v_add_u32_e32 v0, vcc, 32, v0
; VI-NEXT:    v_ffbl_b32_e32 v4, v2
...
; VI-NEXT:    buffer_load_ubyte v0, off, s[8:11], 0
; VI-NEXT:    buffer_load_ubyte v1, off, s[8:11], 0 offset:1
; VI-NEXT:    v_mov_b32_e32 v2, 0xffff
; VI-NEXT:    s_mov_b32 s0, s4
; VI-NEXT:    s_mov_b32 s1, s5
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_lshlrev_b16_e32 v1, 8, v1
; VI-NEXT:    v_or_b32_e32 v0, v1, v0
; VI-NEXT:    v_or_b32_e32 v1, 0x10000, v0
; VI-NEXT:    v_ffbl_b32_e32 v3, v1
; VI-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; VI-NEXT:    v_cndmask_b32_e32 v1, 32, v3, vcc
; VI-NEXT:    v_cmp_ne_u16_e32 vcc, 0, v0
