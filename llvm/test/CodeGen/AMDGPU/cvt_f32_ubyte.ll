...
; SI-NEXT:    buffer_load_ubyte v3, v[0:1], s[4:7], 0 addr64 offset:2
...
; VI-NEXT:    v_add_u16_e32 v0, s12, v0
...
; GFX10-NEXT:    s_movk_i32 s4, 0x900
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    global_load_dword v0, v0, s[2:3]
...
; GFX10-NEXT:    v_mov_b32_e32 v4, 0
; GFX10-NEXT:    v_cvt_f32_ubyte3_e32 v3, v0
; GFX10-NEXT:    v_add_nc_u16 v1, v1, s4
; GFX10-NEXT:    v_add_nc_u16 v5, v2, s4
; GFX10-NEXT:    v_cvt_f32_ubyte2_e32 v2, v0
...
; SI-NEXT:    buffer_load_ubyte v6, v[0:1], s[4:7], 0 addr64 offset:2
; SI-NEXT:    buffer_load_ubyte v4, v[0:1], s[4:7], 0 addr64 offset:3
; SI-NEXT:    buffer_load_ubyte v7, v[0:1], s[4:7], 0 addr64 offset:4
; SI-NEXT:    buffer_load_ubyte v5, v[0:1], s[4:7], 0 addr64 offset:5
...
; SI-NEXT:    buffer_store_dword v2, off, s[0:3], 0 offset:24
; SI-NEXT:    s_waitcnt expcnt(0)
