...
; GFX9-NEXT:    global_load_ubyte v2, v[0:1], off offset:2
...
; GFX9-NEXT:    global_load_ubyte v2, v[0:1], off offset:2
; GFX9-NEXT:    global_load_ubyte v3, v[0:1], off offset:3
; GFX9-NEXT:    global_load_ushort v6, v[0:1], off offset:4
; GFX9-NEXT:    global_load_ubyte v7, v[0:1], off offset:6
...
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v3, v3
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_and_b32_e32 v9, 0xffff, v6
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v6, v7
...
; SI-NEXT:    s_mov_b32 s7, s3
; SI-NEXT:    s_waitcnt vmcnt(1)
; SI-NEXT:    buffer_load_ubyte v3, v[0:1], s[4:7], 0 addr64
; SI-NEXT:    buffer_load_ubyte v4, v[0:1], s[4:7], 0 addr64 offset:1
; SI-NEXT:    buffer_load_ubyte v5, v[0:1], s[4:7], 0 addr64 offset:2
; SI-NEXT:    buffer_load_ubyte v0, v[0:1], s[4:7], 0 addr64 offset:3
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cvt_f32_ubyte0_e32 v0, v0
; SI-NEXT:    v_fma_f32 v0, v2, v0, 0.5
...
; SI-NEXT:  BB40_1: ; %for.body.i
; SI-NEXT:    ; =>This Inner Loop Header: Depth=1
; SI-NEXT:    s_branch BB40_1
;
...
; VI-NEXT:  BB40_1: ; =>This Inner Loop Header: Depth=1
; VI-NEXT:    s_waitcnt vmcnt(0)
...
; VI-NEXT:    s_cbranch_execnz BB40_1
; VI-NEXT:  ; %bb.2:
; VI-NEXT:    s_mov_b64 exec, s[4:5]
; VI-NEXT:    s_mov_b64 s[4:5], exec
; VI-NEXT:  BB40_3: ; =>This Inner Loop Header: Depth=1
; VI-NEXT:    v_readfirstlane_b32 s8, v0
; VI-NEXT:    v_readfirstlane_b32 s9, v1
; VI-NEXT:    v_readfirstlane_b32 s10, v2
; VI-NEXT:    v_readfirstlane_b32 s11, v3
...
; VI-NEXT:    s_xor_b64 exec, exec, s[0:1]
; VI-NEXT:    s_cbranch_execnz BB40_3
; VI-NEXT:  ; %bb.4:
; VI-NEXT:    s_mov_b64 exec, s[4:5]
; VI-NEXT:    s_mov_b64 s[4:5], exec
; VI-NEXT:  BB40_5: ; =>This Inner Loop Header: Depth=1
; VI-NEXT:    v_readfirstlane_b32 s8, v0
; VI-NEXT:    v_readfirstlane_b32 s9, v1
; VI-NEXT:    v_readfirstlane_b32 s10, v2
; VI-NEXT:    v_readfirstlane_b32 s11, v3
...
; VI-NEXT:    s_xor_b64 exec, exec, s[0:1]
; VI-NEXT:    s_cbranch_execnz BB40_5
; VI-NEXT:  ; %bb.6:
; VI-NEXT:    s_mov_b64 exec, s[4:5]
; VI-NEXT:    s_mov_b64 s[4:5], exec
; VI-NEXT:  BB40_7: ; =>This Inner Loop Header: Depth=1
; VI-NEXT:    v_readfirstlane_b32 s8, v0
; VI-NEXT:    v_readfirstlane_b32 s9, v1
; VI-NEXT:    v_readfirstlane_b32 s10, v2
; VI-NEXT:    v_readfirstlane_b32 s11, v3
...
; VI-NEXT:    s_xor_b64 exec, exec, s[0:1]
; VI-NEXT:    s_cbranch_execnz BB40_7
; VI-NEXT:  ; %bb.8:
; VI-NEXT:    s_mov_b64 exec, s[4:5]
...
; VI-NEXT:  BB40_9: ; %for.body.i
; VI-NEXT:    ; =>This Inner Loop Header: Depth=1
; VI-NEXT:    s_branch BB40_9
;
