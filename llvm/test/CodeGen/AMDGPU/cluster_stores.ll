...
; RUN: llc -march=amdgcn -mcpu=gfx900 -mattr=-xnack -verify-machineinstrs -debug-only=machine-scheduler < %s 2> %t | FileCheck --enable-var-scope --check-prefix=CHECK %s
...
; CHECK-NEXT:    flat_load_dword v3, v[0:1] offset:8
; CHECK-NEXT:    flat_load_dword v4, v[0:1] offset:16
; CHECK-NEXT:    flat_load_dword v5, v[0:1] offset:24
; CHECK-NEXT:    v_mov_b32_e32 v0, s2
; CHECK-NEXT:    v_mov_b32_e32 v1, s3
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_dword v[0:1], v2
; CHECK-NEXT:    flat_store_dword v[0:1], v3 offset:8
; CHECK-NEXT:    flat_store_dword v[0:1], v4 offset:16
; CHECK-NEXT:    flat_store_dword v[0:1], v5 offset:24
; CHECK-NEXT:    s_endpgm
bb:
...
; CHECK-NEXT:    flat_store_dword v[0:1], v4 offset:16
; CHECK-NEXT:    flat_store_dword v[0:1], v2 offset:8
; CHECK-NEXT:    flat_store_dword v[0:1], v5 offset:24
; CHECK-NEXT:    s_endpgm
bb:
...
; CHECK-NEXT:    v_add_u32_e32 v6, 2, v0
; CHECK-NEXT:    v_add_u32_e32 v7, 2, v1
; CHECK-NEXT:    image_load v[2:5], v[2:3], s[0:7] dmask:0xf unorm
; CHECK-NEXT:    image_load v[6:9], v[6:7], s[0:7] dmask:0xf unorm
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_add_f32_e32 v5, v5, v9
; CHECK-NEXT:    v_add_f32_e32 v4, v4, v8
; CHECK-NEXT:    v_add_f32_e32 v3, v3, v7
; CHECK-NEXT:    v_add_f32_e32 v2, v2, v6
; CHECK-NEXT:    image_store v[2:5], v[0:1], s[8:15] dmask:0xf unorm
; CHECK-NEXT:    s_endpgm
entry:
  %x1 = add i32 %x, 1
  %y1 = add i32 %y, 1
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    image_load v[2:5], v[0:1], s[0:7] dmask:0xf unorm
; CHECK-NEXT:    image_load v[6:9], v[0:1], s[8:15] dmask:0xf unorm
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_add_f32_e32 v5, v5, v9
; CHECK-NEXT:    v_add_f32_e32 v4, v4, v8
; CHECK-NEXT:    v_add_f32_e32 v3, v3, v7
; CHECK-NEXT:    v_add_f32_e32 v2, v2, v6
; CHECK-NEXT:    image_store v[2:5], v[0:1], s[16:23] dmask:0xf unorm
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    v_cvt_f32_i32_e32 v8, v0
; CHECK-NEXT:    v_cvt_f32_i32_e32 v9, v1
; CHECK-NEXT:    v_mov_b32_e32 v4, 0
; CHECK-NEXT:    v_mov_b32_e32 v10, 1.0
; CHECK-NEXT:    v_add_f32_e32 v2, 1.0, v8
; CHECK-NEXT:    v_add_f32_e32 v3, 1.0, v9
; CHECK-NEXT:    v_mov_b32_e32 v5, v4
; CHECK-NEXT:    v_mov_b32_e32 v6, v4
; CHECK-NEXT:    v_mov_b32_e32 v7, v4
; CHECK-NEXT:    v_add_f32_e32 v8, 2.0, v8
; CHECK-NEXT:    v_add_f32_e32 v9, 2.0, v9
; CHECK-NEXT:    v_mov_b32_e32 v11, v10
; CHECK-NEXT:    v_mov_b32_e32 v12, v10
; CHECK-NEXT:    v_mov_b32_e32 v13, v10
; CHECK-NEXT:    image_sample_d v[2:5], v[2:9], s[0:7], s[8:11] dmask:0xf
; CHECK-NEXT:    image_sample_d v[6:9], v[8:15], s[0:7], s[8:11] dmask:0xf
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_add_f32_e32 v5, v5, v9
; CHECK-NEXT:    v_add_f32_e32 v4, v4, v8
; CHECK-NEXT:    v_add_f32_e32 v3, v3, v7
; CHECK-NEXT:    v_add_f32_e32 v2, v2, v6
; CHECK-NEXT:    image_store v[2:5], v[0:1], s[12:19] dmask:0xf unorm
; CHECK-NEXT:    s_endpgm
entry:
