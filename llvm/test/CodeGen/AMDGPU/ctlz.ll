...
; VI-NEXT:    s_mov_b32 s1, s5
; VI-NEXT:    s_flbit_i32_b32 s5, s7
; VI-NEXT:    s_cmp_eq_u32 s7, 0
; VI-NEXT:    s_cselect_b32 s4, s4, s5
; VI-NEXT:    s_or_b32 s5, s6, s7
; VI-NEXT:    s_cmp_lg_u32 s5, 0
; VI-NEXT:    s_cselect_b32 s4, s4, 64
...
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_flbit_i32_b32 s4, s2
; GFX10-NEXT:    s_flbit_i32_b32 s5, s3
; GFX10-NEXT:    s_add_i32 s4, s4, 32
; GFX10-NEXT:    s_cmp_eq_u32 s3, 0
; GFX10-NEXT:    s_cselect_b32 s4, s4, s5
; GFX10-NEXT:    s_or_b32 s2, s2, s3
; GFX10-NEXT:    s_cmp_lg_u32 s2, 0
; GFX10-NEXT:    s_cselect_b32 s2, s4, 64
