...
; GFX900-NEXT:    global_load_dwordx2 v[9:10], v[7:8], off
; GFX900-NEXT:    global_load_dwordx2 v[11:12], v[7:8], off offset:2048
; GFX900-NEXT:    v_addc_co_u32_e32 v14, vcc, 0, v1, vcc
; GFX900-NEXT:    global_load_dwordx2 v[15:16], v[0:1], off
; GFX900-NEXT:    global_load_dwordx2 v[17:18], v[0:1], off offset:2048
; GFX900-NEXT:    global_load_dwordx2 v[19:20], v[5:6], off offset:2048
; GFX900-NEXT:    global_load_dwordx2 v[21:22], v[13:14], off
; GFX900-NEXT:    global_load_dwordx2 v[23:24], v[7:8], off offset:-4096
; GFX900-NEXT:    global_load_dwordx2 v[25:26], v[13:14], off offset:2048
; GFX900-NEXT:    s_waitcnt vmcnt(4)
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, v17, v15
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, v18, v16, vcc
...
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, v25, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, v26, v1, vcc
...
; GFX10-NEXT:    v_add_co_u32 v2, vcc_lo, s34, v2
; GFX10-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, s35, v3, vcc_lo
...
; GFX90A-NEXT:    global_load_dwordx2 v[8:9], v[6:7], off
; GFX90A-NEXT:    global_load_dwordx2 v[10:11], v[6:7], off offset:2048
; GFX90A-NEXT:    v_addc_co_u32_e32 v13, vcc, 0, v3, vcc
; GFX90A-NEXT:    global_load_dwordx2 v[14:15], v[2:3], off
; GFX90A-NEXT:    global_load_dwordx2 v[16:17], v[2:3], off offset:2048
; GFX90A-NEXT:    global_load_dwordx2 v[18:19], v[4:5], off offset:2048
; GFX90A-NEXT:    global_load_dwordx2 v[20:21], v[12:13], off
; GFX90A-NEXT:    global_load_dwordx2 v[22:23], v[6:7], off offset:-4096
; GFX90A-NEXT:    global_load_dwordx2 v[24:25], v[12:13], off offset:2048
; GFX90A-NEXT:    s_waitcnt vmcnt(4)
; GFX90A-NEXT:    v_add_co_u32_e32 v2, vcc, v16, v14
; GFX90A-NEXT:    v_addc_co_u32_e32 v3, vcc, v17, v15, vcc
...
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, v6, v5, vcc
...
; GFX8-NEXT:    s_cbranch_scc0 BB1_2
...
; GFX8-NEXT:    s_cbranch_scc1 BB1_5
; GFX8-NEXT:  ; %bb.4: ; in Loop: Header=BB1_1 Depth=1
; GFX8-NEXT:    s_mov_b32 s0, s1
; GFX8-NEXT:    s_branch BB1_1
; GFX8-NEXT:  BB1_5: ; %while.end
...
; GFX900-NEXT:    v_mov_b32_e32 v6, s35
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, s34, v4
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, v6, v5, vcc
; GFX900-NEXT:    v_or_b32_e32 v2, v4, v2
; GFX900-NEXT:    v_add_co_u32_e32 v2, vcc, s34, v2
; GFX900-NEXT:    v_addc_co_u32_e32 v3, vcc, v3, v6, vcc
...
; GFX900-NEXT:  BB1_1: ; %for.cond.preheader
...
; GFX900-NEXT:    v_add_co_u32_e32 v16, vcc, s0, v4
...
; GFX900-NEXT:    v_add_co_u32_e32 v18, vcc, s1, v4
; GFX900-NEXT:    v_addc_co_u32_e32 v19, vcc, -1, v5, vcc
; GFX900-NEXT:    v_add_co_u32_e32 v14, vcc, s3, v4
; GFX900-NEXT:    v_addc_co_u32_e32 v15, vcc, -1, v5, vcc
; GFX900-NEXT:    global_load_dwordx2 v[16:17], v[18:19], off
; GFX900-NEXT:    s_addk_i32 s4, 0x2000
; GFX900-NEXT:    s_cmp_gt_u32 s4, 0x3fffff
; GFX900-NEXT:    s_waitcnt vmcnt(4)
; GFX900-NEXT:    v_add_co_u32_e32 v30, vcc, v8, v6
; GFX900-NEXT:    v_addc_co_u32_e32 v31, vcc, v9, v7, vcc
; GFX900-NEXT:    global_load_dwordx2 v[6:7], v[18:19], off offset:-2048
; GFX900-NEXT:    global_load_dwordx2 v[8:9], v[18:19], off offset:-4096
; GFX900-NEXT:    global_load_dwordx2 v[26:27], v[14:15], off offset:-2048
; GFX900-NEXT:    global_load_dwordx2 v[28:29], v[4:5], off
; GFX900-NEXT:    v_add_co_u32_e32 v4, vcc, 0x10000, v4
; GFX900-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v5, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(7)
; GFX900-NEXT:    v_add_co_u32_e32 v14, vcc, v20, v30
; GFX900-NEXT:    v_addc_co_u32_e32 v15, vcc, v21, v31, vcc
...
; GFX900-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v8
; GFX900-NEXT:    v_addc_co_u32_e32 v7, vcc, v7, v9, vcc
; GFX900-NEXT:    v_add_co_u32_e32 v6, vcc, v16, v6
; GFX900-NEXT:    v_addc_co_u32_e32 v7, vcc, v17, v7, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(1)
...
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    v_add_co_u32_e32 v6, vcc, v28, v6
; GFX900-NEXT:    v_addc_co_u32_e32 v7, vcc, v29, v7, vcc
; GFX900-NEXT:    s_cbranch_scc0 BB1_2
...
; GFX900-NEXT:    s_cbranch_scc1 BB1_5
; GFX900-NEXT:  ; %bb.4: ; in Loop: Header=BB1_1 Depth=1
; GFX900-NEXT:    s_mov_b32 s2, s4
; GFX900-NEXT:    s_branch BB1_1
; GFX900-NEXT:  BB1_5: ; %while.end
...
; GFX10-NEXT:    v_add_co_u32 v6, vcc_lo, v0, s34
; GFX10-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, s35, v1, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v0, vcc_lo, s34, v2
; GFX10-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, s35, v3, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v2, vcc_lo, 0x5000, v6
; GFX10-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v7, vcc_lo
; GFX10-NEXT:  BB1_1: ; %for.cond.preheader
; GFX10-NEXT:    ; =>This Loop Header: Depth=1
; GFX10-NEXT:    ; Child Loop BB1_2 Depth 2
; GFX10-NEXT:    v_mov_b32_e32 v7, v3
; GFX10-NEXT:    v_mov_b32_e32 v6, v2
; GFX10-NEXT:    s_mov_b32 s2, 0
; GFX10-NEXT:  BB1_2: ; %for.body
...
; GFX10-NEXT:    s_cbranch_scc0 BB1_2
...
; GFX10-NEXT:    s_cbranch_scc1 BB1_5
; GFX10-NEXT:  ; %bb.4: ; in Loop: Header=BB1_1 Depth=1
; GFX10-NEXT:    s_mov_b32 s1, s0
; GFX10-NEXT:    s_branch BB1_1
; GFX10-NEXT:  BB1_5: ; %while.end
...
; GFX90A-NEXT:  BB1_1: ; %for.cond.preheader
...
; GFX90A-NEXT:    global_load_dwordx2 v[22:23], v[14:15], off
; GFX90A-NEXT:    global_load_dwordx2 v[24:25], v[16:17], off offset:-2048
; GFX90A-NEXT:    v_add_co_u32_e32 v18, vcc, s1, v6
; GFX90A-NEXT:    v_addc_co_u32_e32 v19, vcc, -1, v7, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v14, vcc, s3, v6
; GFX90A-NEXT:    global_load_dwordx2 v[16:17], v[18:19], off offset:-2048
; GFX90A-NEXT:    global_load_dwordx2 v[26:27], v[18:19], off
; GFX90A-NEXT:    v_addc_co_u32_e32 v15, vcc, -1, v7, vcc
; GFX90A-NEXT:    global_load_dwordx2 v[28:29], v[18:19], off offset:-4096
; GFX90A-NEXT:    global_load_dwordx2 v[30:31], v[14:15], off offset:-2048
; GFX90A-NEXT:    global_load_dwordx2 v[32:33], v[6:7], off
...
; GFX90A-NEXT:    s_cbranch_scc0 BB1_2
...
; GFX90A-NEXT:    s_cbranch_scc1 BB1_5
; GFX90A-NEXT:  ; %bb.4: ; in Loop: Header=BB1_1 Depth=1
; GFX90A-NEXT:    s_mov_b32 s2, s4
; GFX90A-NEXT:    s_branch BB1_1
; GFX90A-NEXT:  BB1_5: ; %while.end
...
; GFX900-NEXT:    global_load_dword v9, v[0:1], off offset:1024
; GFX900-NEXT:    global_load_dword v10, v[0:1], off offset:2048
; GFX900-NEXT:    global_load_dword v11, v[0:1], off offset:3072
; GFX900-NEXT:    global_load_dword v12, v[5:6], off
; GFX900-NEXT:    global_load_dword v13, v[5:6], off offset:1024
; GFX900-NEXT:    global_load_dword v14, v[5:6], off offset:2048
; GFX900-NEXT:    global_load_dword v15, v[5:6], off offset:3072
; GFX900-NEXT:    v_add_co_u32_e32 v7, vcc, 0x2000, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v8, vcc, 0, v1, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(6)
; GFX900-NEXT:    v_add_u32_e32 v0, v9, v2
; GFX900-NEXT:    global_load_dword v1, v[7:8], off
; GFX900-NEXT:    global_load_dword v2, v[7:8], off offset:1024
; GFX900-NEXT:    s_waitcnt vmcnt(6)
; GFX900-NEXT:    v_add3_u32 v0, v10, v0, v11
; GFX900-NEXT:    s_waitcnt vmcnt(4)
; GFX900-NEXT:    v_add3_u32 v0, v12, v0, v13
; GFX900-NEXT:    s_waitcnt vmcnt(2)
; GFX900-NEXT:    v_add3_u32 v0, v14, v0, v15
; GFX900-NEXT:    s_waitcnt vmcnt(0)
...
; GFX90A-NEXT:    v_add_co_u32_e32 v4, vcc, s0, v2
; GFX90A-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v3, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v6, vcc, 0x2000, v2
; GFX90A-NEXT:    global_load_dword v8, v[2:3], off
; GFX90A-NEXT:    global_load_dword v9, v[2:3], off offset:1024
; GFX90A-NEXT:    global_load_dword v10, v[2:3], off offset:2048
; GFX90A-NEXT:    global_load_dword v11, v[2:3], off offset:3072
; GFX90A-NEXT:    global_load_dword v12, v[4:5], off
; GFX90A-NEXT:    global_load_dword v13, v[4:5], off offset:1024
; GFX90A-NEXT:    global_load_dword v14, v[4:5], off offset:2048
; GFX90A-NEXT:    global_load_dword v15, v[4:5], off offset:3072
; GFX90A-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v3, vcc
; GFX90A-NEXT:    global_load_dword v3, v[6:7], off
; GFX90A-NEXT:    global_load_dword v4, v[6:7], off offset:1024
; GFX90A-NEXT:    s_waitcnt vmcnt(8)
...
; GFX90A-NEXT:    s_waitcnt vmcnt(2)
; GFX90A-NEXT:    v_add3_u32 v2, v14, v2, v15
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_add3_u32 v2, v3, v2, v4
...
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, s0, v0
; GFX8-NEXT:    v_addc_u32_e32 v8, vcc, 0, v1, vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 0, v0
; GFX8-NEXT:    v_addc_u32_e32 v10, vcc, 1, v1, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
; GFX8-NEXT:    flat_load_dwordx2 v[5:6], v[5:6]
; GFX8-NEXT:    flat_load_dwordx2 v[7:8], v[7:8]
; GFX8-NEXT:    flat_load_dwordx2 v[9:10], v[9:10]
...
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, v8, v1, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v9, v0
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, v10, v1, vcc
; GFX8-NEXT:    flat_store_dwordx2 v[3:4], v[0:1]
; GFX8-NEXT:    s_endpgm
;
...
; GFX900-NEXT:    v_add_co_u32_e32 v3, vcc, s34, v0
; GFX900-NEXT:    v_lshlrev_b64 v[0:1], 3, v[1:2]
; GFX900-NEXT:    v_addc_co_u32_e32 v4, vcc, v5, v4, vcc
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, v3, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, v4, v1, vcc
...
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, 0, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, 1, v1, vcc
; GFX900-NEXT:    global_load_dwordx2 v[9:10], v[0:1], off
; GFX900-NEXT:    global_load_dwordx2 v[11:12], v[0:1], off offset:-4096
; GFX900-NEXT:    global_load_dwordx2 v[13:14], v[7:8], off offset:2048
; GFX900-NEXT:    s_waitcnt vmcnt(1)
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, v11, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, v12, v6, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(0)
...
; GFX90A-NEXT:    v_mov_b32_e32 v3, 0
; GFX90A-NEXT:    v_mov_b32_e32 v1, 0
; GFX90A-NEXT:    v_mov_b32_e32 v4, s35
; GFX90A-NEXT:    v_add_co_u32_e32 v0, vcc, s34, v0
...
; GFX90A-NEXT:    global_load_dwordx2 v[10:11], v[2:3], off offset:-4096
; GFX90A-NEXT:    global_load_dwordx2 v[12:13], v[6:7], off offset:2048
; GFX90A-NEXT:    s_waitcnt vmcnt(1)
; GFX90A-NEXT:    v_add_co_u32_e32 v2, vcc, v10, v4
; GFX90A-NEXT:    v_addc_co_u32_e32 v3, vcc, v11, v5, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, s0, v0
; GFX8-NEXT:    v_addc_u32_e32 v8, vcc, 0, v1, vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 0x80000000, v0
; GFX8-NEXT:    v_addc_u32_e32 v10, vcc, 0, v1, vcc
; GFX8-NEXT:    flat_load_dword v0, v[0:1]
; GFX8-NEXT:    flat_load_dword v1, v[5:6]
; GFX8-NEXT:    flat_load_dword v2, v[7:8]
; GFX8-NEXT:    flat_load_dword v5, v[9:10]
; GFX8-NEXT:    s_waitcnt vmcnt(2)
...
; GFX8-NEXT:    v_addc_u32_e32 v13, vcc, v4, v3, vcc
; GFX8-NEXT:    s_movk_i32 s0, 0x1000
...
; GFX10-NEXT:    v_add_co_u32 v0, vcc_lo, s36, v2
; GFX10-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, s37, v3, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v14, vcc_lo, s38, v2
; GFX10-NEXT:    v_add_co_ci_u32_e32 v15, vcc_lo, s39, v3, vcc_lo
...
; GFX900-NEXT:    v_addc_co_u32_e32 v8, vcc, 0, v1, vcc
; GFX900-NEXT:    s_movk_i32 s0, 0x2000
; GFX900-NEXT:    v_add_co_u32_e32 v9, vcc, s0, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v10, vcc, 0, v1, vcc
; GFX900-NEXT:    s_movk_i32 s0, 0x1000
; GFX900-NEXT:    global_load_dwordx2 v[5:6], v[0:1], off
; GFX900-NEXT:    v_add_co_u32_e32 v11, vcc, s0, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v12, vcc, 0, v1, vcc
; GFX900-NEXT:    global_load_dwordx2 v[13:14], v[11:12], off offset:2048
; GFX900-NEXT:    global_load_dwordx2 v[15:16], v[11:12], off
; GFX900-NEXT:    global_load_dwordx2 v[17:18], v[9:10], off offset:2048
; GFX900-NEXT:    global_load_dwordx2 v[19:20], v[9:10], off
; GFX900-NEXT:    global_load_dwordx2 v[21:22], v[7:8], off offset:2048
; GFX900-NEXT:    global_load_dwordx2 v[23:24], v[7:8], off
; GFX900-NEXT:    global_load_dwordx2 v[25:26], v[0:1], off offset:2048
; GFX900-NEXT:    s_waitcnt vmcnt(2)
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, v21, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, v22, v6, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(1)
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, v23, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, v24, v1, vcc
...
; GFX90A-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v3, vcc
; GFX90A-NEXT:    s_movk_i32 s0, 0x2000
; GFX90A-NEXT:    v_add_co_u32_e32 v8, vcc, s0, v2
; GFX90A-NEXT:    v_addc_co_u32_e32 v9, vcc, 0, v3, vcc
; GFX90A-NEXT:    s_movk_i32 s0, 0x1000
; GFX90A-NEXT:    global_load_dwordx2 v[4:5], v[2:3], off
; GFX90A-NEXT:    v_add_co_u32_e32 v10, vcc, s0, v2
; GFX90A-NEXT:    v_addc_co_u32_e32 v11, vcc, 0, v3, vcc
; GFX90A-NEXT:    global_load_dwordx2 v[12:13], v[10:11], off offset:2048
; GFX90A-NEXT:    global_load_dwordx2 v[14:15], v[10:11], off
; GFX90A-NEXT:    global_load_dwordx2 v[16:17], v[8:9], off offset:2048
; GFX90A-NEXT:    global_load_dwordx2 v[18:19], v[8:9], off
; GFX90A-NEXT:    global_load_dwordx2 v[20:21], v[6:7], off offset:2048
; GFX90A-NEXT:    global_load_dwordx2 v[22:23], v[6:7], off
; GFX90A-NEXT:    global_load_dwordx2 v[24:25], v[2:3], off offset:2048
; GFX90A-NEXT:    s_waitcnt vmcnt(2)
; GFX90A-NEXT:    v_add_co_u32_e32 v2, vcc, v20, v4
; GFX90A-NEXT:    v_addc_co_u32_e32 v3, vcc, v21, v5, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(1)
; GFX90A-NEXT:    v_add_co_u32_e32 v2, vcc, v22, v2
; GFX90A-NEXT:    v_addc_co_u32_e32 v3, vcc, v23, v3, vcc
