...
define amdgpu_gs void @_amdgpu_gs_main(i32 inreg %primShaderTableAddrLow, <31 x i32> inreg %userData) {
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   undef %56.sub0:sgpr_64 = PRED_COPY $sgpr31
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr27
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr25
  ; CHECK-NEXT:   [[PRED_COPY2:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr5
  ; CHECK-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr4
  ; CHECK-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr3
  ; CHECK-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr18
  ; CHECK-NEXT:   undef %50.sub0:sgpr_64 = PRED_COPY $sgpr19
  ; CHECK-NEXT:   [[PRED_COPY6:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr20
  ; CHECK-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr21
  ; CHECK-NEXT:   [[PRED_COPY8:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr22
  ; CHECK-NEXT:   [[PRED_COPY9:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr23
  ; CHECK-NEXT:   [[PRED_COPY10:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr9
  ; CHECK-NEXT:   [[PRED_COPY11:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr10
  ; CHECK-NEXT:   [[PRED_COPY12:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr8
  ...
  ; CHECK-NEXT:   [[S_LSHL_B32_:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY4]], 4, implicit-def dead $scc
  ; CHECK-NEXT:   [[S_LSHL_B32_1:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY3]], 4, implicit-def dead $scc
  ; CHECK-NEXT:   [[S_LSHL_B32_2:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY2]], 4, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   undef %130.sub0:sreg_64 = S_ADD_U32 [[PRED_COPY5]], [[S_LSHL_B32_2]], implicit-def $scc
  ...
  ; CHECK-NEXT:   [[S_ADD_U32_:%[0-9]+]]:sreg_32 = S_ADD_U32 [[PRED_COPY5]], 64, implicit-def $scc
  ...
  ; CHECK-NEXT:   undef %273.sub0:sreg_64 = S_ADD_U32 [[PRED_COPY6]], [[S_LSHL_B32_]], implicit-def $scc
  ; CHECK-NEXT:   %273.sub1:sreg_64 = S_ADDC_U32 undef %48:sreg_32, [[S_ASHR_I32_]], implicit-def dead $scc, implicit $scc
  ; CHECK-NEXT:   undef %286.sub0:sreg_64 = S_ADD_U32 [[PRED_COPY7]], [[S_LSHL_B32_1]], implicit-def $scc
  ; CHECK-NEXT:   %286.sub1:sreg_64 = S_ADDC_U32 undef %45:sreg_32, [[S_ASHR_I32_1]], implicit-def dead $scc, implicit $scc
  ; CHECK-NEXT:   undef %293.sub0:sreg_64 = S_ADD_U32 [[PRED_COPY7]], [[S_LSHL_B32_2]], implicit-def $scc
  ...
  ; CHECK-NEXT:   undef %327.sub0:sreg_64 = S_ADD_U32 [[PRED_COPY8]], [[S_LSHL_B32_]], implicit-def $scc
  ; CHECK-NEXT:   %327.sub1:sreg_64 = S_ADDC_U32 undef %42:sreg_32, [[S_ASHR_I32_]], implicit-def dead $scc, implicit $scc
  ; CHECK-NEXT:   undef %335.sub0:sreg_64 = S_ADD_U32 [[PRED_COPY9]], [[S_LSHL_B32_]], implicit-def $scc
  ; CHECK-NEXT:   %335.sub1:sreg_64 = S_ADDC_U32 undef %39:sreg_32, [[S_ASHR_I32_]], implicit-def dead $scc, implicit $scc
  ; CHECK-NEXT:   undef %343.sub0:sreg_64 = S_ADD_U32 [[PRED_COPY9]], [[S_LSHL_B32_1]], implicit-def $scc
  ...
  ; CHECK-NEXT:   undef %351.sub0:sreg_64 = S_ADD_U32 [[PRED_COPY9]], [[S_LSHL_B32_2]], implicit-def $scc
  ; CHECK-NEXT:   %351.sub1:sreg_64 = S_ADDC_U32 undef %39:sreg_32, [[S_ASHR_I32_2]], implicit-def dead $scc, implicit $scc
  ; CHECK-NEXT:   [[S_LSHL_B32_3:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY10]], 4, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   [[S_ADD_U32_3:%[0-9]+]]:sreg_32 = S_ADD_U32 [[PRED_COPY1]], 160, implicit-def $scc
  ...
  ; CHECK-NEXT:   [[S_LSHL_B32_4:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY11]], 4, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   [[S_LSHL_B32_5:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY4]], 3, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:sgpr_128 = PRED_COPY %71
  ...
  ; CHECK-NEXT:   [[PRED_COPY13]].sub1:sgpr_128 = PRED_COPY %302.sub1
  ; CHECK-NEXT:   [[PRED_COPY13]].sub0:sgpr_128 = PRED_COPY [[S_LOAD_DWORD_IMM]]
  ; CHECK-NEXT:   [[S_BUFFER_LOAD_DWORD_IMM4:%[0-9]+]]:sreg_32_xm0_xexec = S_BUFFER_LOAD_DWORD_IMM [[PRED_COPY13]], 0, 0 :: (dereferenceable invariant load (s32))
  ...
  ; CHECK-NEXT:   [[S_LSHL_B32_6:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY3]], 3, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:sgpr_128 = PRED_COPY %71
  ...
  ; CHECK-NEXT:   [[PRED_COPY14]].sub0:sgpr_128 = PRED_COPY [[S_LOAD_DWORDX2_IMM]].sub0
  ; CHECK-NEXT:   [[PRED_COPY14]].sub1:sgpr_128 = PRED_COPY [[S_AND_B32_]]
  ; CHECK-NEXT:   [[S_BUFFER_LOAD_DWORD_IMM5:%[0-9]+]]:sreg_32_xm0_xexec = S_BUFFER_LOAD_DWORD_IMM [[PRED_COPY14]], 0, 0 :: (dereferenceable invariant load (s32))
  ...
  ; CHECK-NEXT:   [[S_LSHL_B32_7:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY2]], 3, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:sgpr_128 = PRED_COPY %71
  ; CHECK-NEXT:   [[S_AND_B32_1:%[0-9]+]]:sreg_32 = S_AND_B32 [[S_LOAD_DWORDX2_IMM1]].sub1, 65535, implicit-def dead $scc
  ; CHECK-NEXT:   [[PRED_COPY15]].sub0:sgpr_128 = PRED_COPY [[S_LOAD_DWORDX2_IMM1]].sub0
  ; CHECK-NEXT:   [[PRED_COPY15]].sub1:sgpr_128 = PRED_COPY [[S_AND_B32_1]]
  ; CHECK-NEXT:   [[S_BUFFER_LOAD_DWORD_IMM6:%[0-9]+]]:sreg_32_xm0_xexec = S_BUFFER_LOAD_DWORD_IMM [[PRED_COPY15]], 0, 0 :: (dereferenceable invariant load (s32))
  ...
  ; CHECK-NEXT:   KILL [[PRED_COPY15]].sub0_sub1, [[PRED_COPY15]].sub2_sub3
  ; CHECK-NEXT:   [[S_LSHL_B32_8:%[0-9]+]]:sreg_32 = S_LSHL_B32 [[PRED_COPY12]], 3, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:sgpr_128 = PRED_COPY %71
  ; CHECK-NEXT:   [[PRED_COPY16]].sub1:sgpr_128 = PRED_COPY [[S_AND_B32_2]]
  ; CHECK-NEXT:   [[PRED_COPY16]].sub0:sgpr_128 = PRED_COPY [[S_LOAD_DWORD_IMM2]]
  ; CHECK-NEXT:   [[S_BUFFER_LOAD_DWORD_IMM7:%[0-9]+]]:sreg_32_xm0_xexec = S_BUFFER_LOAD_DWORD_IMM [[PRED_COPY16]], 0, 0 :: (dereferenceable invariant load (s32))
  ...
  ; CHECK-NEXT:   [[S_ADD_U32_5:%[0-9]+]]:sreg_32 = S_ADD_U32 [[PRED_COPY]], 96, implicit-def $scc
