...
struct AreSame : std::conjunction<std::is_same<HeadT, TailTs>...> {};
...
static constexpr auto makeThunkArray(HeadThunkT &&HeadThunk,
  ...
  return std::array{std::forward<HeadThunkT>(HeadThunk),
...
template <
    ...
    typename std::enable_if_t<
        std::conjunction<variant_traits_detail::HasTraits<VariantTs>...>::value,
        int> = 0>
...
template <typename VisitorT, typename HeadVariantT, typename... TailVariantTs,
          typename std::enable_if_t<
              std::conjunction<
                  variant_traits_detail::HasTraits<HeadVariantT>,
...
visitSameAlternative(VisitorT &&Visitor, HeadVariantT &&HeadVariant,
                     TailVariantTs &&...TailVariants) {
  static_assert(
      std::conjunction<std::is_same<remove_cvref_t<HeadVariantT>,
